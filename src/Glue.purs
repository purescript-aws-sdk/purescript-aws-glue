...
newAccessDeniedException' :: ( { "Message" :: NullOrUndefined.NullOrUndefined (MessageString) } -> {"Message" :: NullOrUndefined.NullOrUndefined (MessageString) } ) -> AccessDeniedException
...
--   This may be useful if you need to immediately overwrite some of the optional values
newAction' :: ( { "JobName" :: NullOrUndefined.NullOrUndefined (NameString) , "Arguments" :: NullOrUndefined.NullOrUndefined (GenericMap) } -> {"JobName" :: NullOrUndefined.NullOrUndefined (NameString) , "Arguments" :: NullOrUndefined.NullOrUndefined (GenericMap) } ) -> Action
...
--   This may be useful if you need to immediately overwrite some of the optional values
newAlreadyExistsException' :: ( { "Message" :: NullOrUndefined.NullOrUndefined (MessageString) } -> {"Message" :: NullOrUndefined.NullOrUndefined (MessageString) } ) -> AlreadyExistsException
...
--   This may be useful if you need to immediately overwrite some of the optional values
newBatchCreatePartitionRequest' :: NameString -> PartitionInputList -> NameString -> ( { "CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "DatabaseName" :: (NameString) , "TableName" :: (NameString) , "PartitionInputList" :: (PartitionInputList) } -> {"CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "DatabaseName" :: (NameString) , "TableName" :: (NameString) , "PartitionInputList" :: (PartitionInputList) } ) -> BatchCreatePartitionRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newBatchCreatePartitionResponse' :: ( { "Errors" :: NullOrUndefined.NullOrUndefined (PartitionErrors) } -> {"Errors" :: NullOrUndefined.NullOrUndefined (PartitionErrors) } ) -> BatchCreatePartitionResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newBatchDeleteConnectionRequest' :: DeleteConnectionNameList -> ( { "CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "ConnectionNameList" :: (DeleteConnectionNameList) } -> {"CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "ConnectionNameList" :: (DeleteConnectionNameList) } ) -> BatchDeleteConnectionRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newBatchDeleteConnectionResponse' :: ( { "Succeeded" :: NullOrUndefined.NullOrUndefined (NameStringList) , "Errors" :: NullOrUndefined.NullOrUndefined (ErrorByName) } -> {"Succeeded" :: NullOrUndefined.NullOrUndefined (NameStringList) , "Errors" :: NullOrUndefined.NullOrUndefined (ErrorByName) } ) -> BatchDeleteConnectionResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newBatchDeletePartitionResponse' :: ( { "Errors" :: NullOrUndefined.NullOrUndefined (PartitionErrors) } -> {"Errors" :: NullOrUndefined.NullOrUndefined (PartitionErrors) } ) -> BatchDeletePartitionResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newBatchDeleteTableRequest' :: NameString -> BatchDeleteTableNameList -> ( { "CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "DatabaseName" :: (NameString) , "TablesToDelete" :: (BatchDeleteTableNameList) } -> {"CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "DatabaseName" :: (NameString) , "TablesToDelete" :: (BatchDeleteTableNameList) } ) -> BatchDeleteTableRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newBatchDeleteTableResponse' :: ( { "Errors" :: NullOrUndefined.NullOrUndefined (TableErrors) } -> {"Errors" :: NullOrUndefined.NullOrUndefined (TableErrors) } ) -> BatchDeleteTableResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newBatchDeleteTableVersionRequest' :: NameString -> NameString -> BatchDeleteTableVersionList -> ( { "CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "DatabaseName" :: (NameString) , "TableName" :: (NameString) , "VersionIds" :: (BatchDeleteTableVersionList) } -> {"CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "DatabaseName" :: (NameString) , "TableName" :: (NameString) , "VersionIds" :: (BatchDeleteTableVersionList) } ) -> BatchDeleteTableVersionRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newBatchDeleteTableVersionResponse' :: ( { "Errors" :: NullOrUndefined.NullOrUndefined (TableVersionErrors) } -> {"Errors" :: NullOrUndefined.NullOrUndefined (TableVersionErrors) } ) -> BatchDeleteTableVersionResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newBatchGetPartitionRequest' :: NameString -> BatchGetPartitionValueList -> NameString -> ( { "CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "DatabaseName" :: (NameString) , "TableName" :: (NameString) , "PartitionsToGet" :: (BatchGetPartitionValueList) } -> {"CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "DatabaseName" :: (NameString) , "TableName" :: (NameString) , "PartitionsToGet" :: (BatchGetPartitionValueList) } ) -> BatchGetPartitionRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newBatchGetPartitionResponse' :: ( { "Partitions" :: NullOrUndefined.NullOrUndefined (PartitionList) , "UnprocessedKeys" :: NullOrUndefined.NullOrUndefined (BatchGetPartitionValueList) } -> {"Partitions" :: NullOrUndefined.NullOrUndefined (PartitionList) , "UnprocessedKeys" :: NullOrUndefined.NullOrUndefined (BatchGetPartitionValueList) } ) -> BatchGetPartitionResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newBatchStopJobRunError' :: ( { "JobName" :: NullOrUndefined.NullOrUndefined (NameString) , "JobRunId" :: NullOrUndefined.NullOrUndefined (IdString) , "ErrorDetail" :: NullOrUndefined.NullOrUndefined (ErrorDetail) } -> {"JobName" :: NullOrUndefined.NullOrUndefined (NameString) , "JobRunId" :: NullOrUndefined.NullOrUndefined (IdString) , "ErrorDetail" :: NullOrUndefined.NullOrUndefined (ErrorDetail) } ) -> BatchStopJobRunError
...
--   This may be useful if you need to immediately overwrite some of the optional values
newBatchStopJobRunResponse' :: ( { "SuccessfulSubmissions" :: NullOrUndefined.NullOrUndefined (BatchStopJobRunSuccessfulSubmissionList) , "Errors" :: NullOrUndefined.NullOrUndefined (BatchStopJobRunErrorList) } -> {"SuccessfulSubmissions" :: NullOrUndefined.NullOrUndefined (BatchStopJobRunSuccessfulSubmissionList) , "Errors" :: NullOrUndefined.NullOrUndefined (BatchStopJobRunErrorList) } ) -> BatchStopJobRunResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newBatchStopJobRunSuccessfulSubmission' :: ( { "JobName" :: NullOrUndefined.NullOrUndefined (NameString) , "JobRunId" :: NullOrUndefined.NullOrUndefined (IdString) } -> {"JobName" :: NullOrUndefined.NullOrUndefined (NameString) , "JobRunId" :: NullOrUndefined.NullOrUndefined (IdString) } ) -> BatchStopJobRunSuccessfulSubmission
...
newtype CatalogImportStatus = CatalogImportStatus 
  ...
  , "ImportTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp)
...
--   This may be useful if you need to immediately overwrite some of the optional values
newCatalogImportStatus' :: ( { "ImportCompleted" :: NullOrUndefined.NullOrUndefined (Boolean) , "ImportTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "ImportedBy" :: NullOrUndefined.NullOrUndefined (NameString) } -> {"ImportCompleted" :: NullOrUndefined.NullOrUndefined (Boolean) , "ImportTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "ImportedBy" :: NullOrUndefined.NullOrUndefined (NameString) } ) -> CatalogImportStatus
...
--   This may be useful if you need to immediately overwrite some of the optional values
newClassifier' :: ( { "GrokClassifier" :: NullOrUndefined.NullOrUndefined (GrokClassifier) , "XMLClassifier" :: NullOrUndefined.NullOrUndefined (XMLClassifier) , "JsonClassifier" :: NullOrUndefined.NullOrUndefined (JsonClassifier) } -> {"GrokClassifier" :: NullOrUndefined.NullOrUndefined (GrokClassifier) , "XMLClassifier" :: NullOrUndefined.NullOrUndefined (XMLClassifier) , "JsonClassifier" :: NullOrUndefined.NullOrUndefined (JsonClassifier) } ) -> Classifier
...
--   This may be useful if you need to immediately overwrite some of the optional values
newCodeGenEdge' :: CodeGenIdentifier -> CodeGenIdentifier -> ( { "Source" :: (CodeGenIdentifier) , "Target" :: (CodeGenIdentifier) , "TargetParameter" :: NullOrUndefined.NullOrUndefined (CodeGenArgName) } -> {"Source" :: (CodeGenIdentifier) , "Target" :: (CodeGenIdentifier) , "TargetParameter" :: NullOrUndefined.NullOrUndefined (CodeGenArgName) } ) -> CodeGenEdge
...
--   This may be useful if you need to immediately overwrite some of the optional values
newCodeGenNode' :: CodeGenNodeArgs -> CodeGenIdentifier -> CodeGenNodeType -> ( { "Id" :: (CodeGenIdentifier) , "NodeType" :: (CodeGenNodeType) , "Args" :: (CodeGenNodeArgs) , "LineNumber" :: NullOrUndefined.NullOrUndefined (Int) } -> {"Id" :: (CodeGenIdentifier) , "NodeType" :: (CodeGenNodeType) , "Args" :: (CodeGenNodeArgs) , "LineNumber" :: NullOrUndefined.NullOrUndefined (Int) } ) -> CodeGenNode
...
--   This may be useful if you need to immediately overwrite some of the optional values
newCodeGenNodeArg' :: CodeGenArgName -> CodeGenArgValue -> ( { "Name" :: (CodeGenArgName) , "Value" :: (CodeGenArgValue) , "Param" :: NullOrUndefined.NullOrUndefined (Boolean) } -> {"Name" :: (CodeGenArgName) , "Value" :: (CodeGenArgValue) , "Param" :: NullOrUndefined.NullOrUndefined (Boolean) } ) -> CodeGenNodeArg
...
--   This may be useful if you need to immediately overwrite some of the optional values
newColumn' :: NameString -> ( { "Name" :: (NameString) , "Type" :: NullOrUndefined.NullOrUndefined (ColumnTypeString) , "Comment" :: NullOrUndefined.NullOrUndefined (CommentString) } -> {"Name" :: (NameString) , "Type" :: NullOrUndefined.NullOrUndefined (ColumnTypeString) , "Comment" :: NullOrUndefined.NullOrUndefined (CommentString) } ) -> Column
...
--   This may be useful if you need to immediately overwrite some of the optional values
newConcurrentModificationException' :: ( { "Message" :: NullOrUndefined.NullOrUndefined (MessageString) } -> {"Message" :: NullOrUndefined.NullOrUndefined (MessageString) } ) -> ConcurrentModificationException
...
--   This may be useful if you need to immediately overwrite some of the optional values
newConcurrentRunsExceededException' :: ( { "Message" :: NullOrUndefined.NullOrUndefined (MessageString) } -> {"Message" :: NullOrUndefined.NullOrUndefined (MessageString) } ) -> ConcurrentRunsExceededException
...
--   This may be useful if you need to immediately overwrite some of the optional values
newCondition' :: ( { "LogicalOperator" :: NullOrUndefined.NullOrUndefined (LogicalOperator) , "JobName" :: NullOrUndefined.NullOrUndefined (NameString) , "State" :: NullOrUndefined.NullOrUndefined (JobRunState) } -> {"LogicalOperator" :: NullOrUndefined.NullOrUndefined (LogicalOperator) , "JobName" :: NullOrUndefined.NullOrUndefined (NameString) , "State" :: NullOrUndefined.NullOrUndefined (JobRunState) } ) -> Condition
...
--   This may be useful if you need to immediately overwrite some of the optional values
newConnection' :: ( { "Name" :: NullOrUndefined.NullOrUndefined (NameString) , "Description" :: NullOrUndefined.NullOrUndefined (DescriptionString) , "ConnectionType" :: NullOrUndefined.NullOrUndefined (ConnectionType) , "MatchCriteria" :: NullOrUndefined.NullOrUndefined (MatchCriteria) , "ConnectionProperties" :: NullOrUndefined.NullOrUndefined (ConnectionProperties) , "PhysicalConnectionRequirements" :: NullOrUndefined.NullOrUndefined (PhysicalConnectionRequirements) , "CreationTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "LastUpdatedTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "LastUpdatedBy" :: NullOrUndefined.NullOrUndefined (NameString) } -> {"Name" :: NullOrUndefined.NullOrUndefined (NameString) , "Description" :: NullOrUndefined.NullOrUndefined (DescriptionString) , "ConnectionType" :: NullOrUndefined.NullOrUndefined (ConnectionType) , "MatchCriteria" :: NullOrUndefined.NullOrUndefined (MatchCriteria) , "ConnectionProperties" :: NullOrUndefined.NullOrUndefined (ConnectionProperties) , "PhysicalConnectionRequirements" :: NullOrUndefined.NullOrUndefined (PhysicalConnectionRequirements) , "CreationTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "LastUpdatedTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "LastUpdatedBy" :: NullOrUndefined.NullOrUndefined (NameString) } ) -> Connection
...
--   This may be useful if you need to immediately overwrite some of the optional values
newConnectionInput' :: ConnectionProperties -> ConnectionType -> NameString -> ( { "Name" :: (NameString) , "Description" :: NullOrUndefined.NullOrUndefined (DescriptionString) , "ConnectionType" :: (ConnectionType) , "MatchCriteria" :: NullOrUndefined.NullOrUndefined (MatchCriteria) , "ConnectionProperties" :: (ConnectionProperties) , "PhysicalConnectionRequirements" :: NullOrUndefined.NullOrUndefined (PhysicalConnectionRequirements) } -> {"Name" :: (NameString) , "Description" :: NullOrUndefined.NullOrUndefined (DescriptionString) , "ConnectionType" :: (ConnectionType) , "MatchCriteria" :: NullOrUndefined.NullOrUndefined (MatchCriteria) , "ConnectionProperties" :: (ConnectionProperties) , "PhysicalConnectionRequirements" :: NullOrUndefined.NullOrUndefined (PhysicalConnectionRequirements) } ) -> ConnectionInput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newConnectionsList' :: ( { "Connections" :: NullOrUndefined.NullOrUndefined (StringList) } -> {"Connections" :: NullOrUndefined.NullOrUndefined (StringList) } ) -> ConnectionsList
...
--   This may be useful if you need to immediately overwrite some of the optional values
newCrawler' :: ( { "Name" :: NullOrUndefined.NullOrUndefined (NameString) , "Role" :: NullOrUndefined.NullOrUndefined (Role) , "Targets" :: NullOrUndefined.NullOrUndefined (CrawlerTargets) , "DatabaseName" :: NullOrUndefined.NullOrUndefined (DatabaseName) , "Description" :: NullOrUndefined.NullOrUndefined (DescriptionString) , "Classifiers" :: NullOrUndefined.NullOrUndefined (ClassifierNameList) , "SchemaChangePolicy" :: NullOrUndefined.NullOrUndefined (SchemaChangePolicy) , "State" :: NullOrUndefined.NullOrUndefined (CrawlerState) , "TablePrefix" :: NullOrUndefined.NullOrUndefined (TablePrefix) , "Schedule" :: NullOrUndefined.NullOrUndefined (Schedule) , "CrawlElapsedTime" :: NullOrUndefined.NullOrUndefined (MillisecondsCount) , "CreationTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "LastUpdated" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "LastCrawl" :: NullOrUndefined.NullOrUndefined (LastCrawlInfo) , "Version" :: NullOrUndefined.NullOrUndefined (VersionId) , "Configuration" :: NullOrUndefined.NullOrUndefined (CrawlerConfiguration) } -> {"Name" :: NullOrUndefined.NullOrUndefined (NameString) , "Role" :: NullOrUndefined.NullOrUndefined (Role) , "Targets" :: NullOrUndefined.NullOrUndefined (CrawlerTargets) , "DatabaseName" :: NullOrUndefined.NullOrUndefined (DatabaseName) , "Description" :: NullOrUndefined.NullOrUndefined (DescriptionString) , "Classifiers" :: NullOrUndefined.NullOrUndefined (ClassifierNameList) , "SchemaChangePolicy" :: NullOrUndefined.NullOrUndefined (SchemaChangePolicy) , "State" :: NullOrUndefined.NullOrUndefined (CrawlerState) , "TablePrefix" :: NullOrUndefined.NullOrUndefined (TablePrefix) , "Schedule" :: NullOrUndefined.NullOrUndefined (Schedule) , "CrawlElapsedTime" :: NullOrUndefined.NullOrUndefined (MillisecondsCount) , "CreationTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "LastUpdated" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "LastCrawl" :: NullOrUndefined.NullOrUndefined (LastCrawlInfo) , "Version" :: NullOrUndefined.NullOrUndefined (VersionId) , "Configuration" :: NullOrUndefined.NullOrUndefined (CrawlerConfiguration) } ) -> Crawler
...
--   This may be useful if you need to immediately overwrite some of the optional values
newCrawlerMetrics' :: ( { "CrawlerName" :: NullOrUndefined.NullOrUndefined (NameString) , "TimeLeftSeconds" :: NullOrUndefined.NullOrUndefined (NonNegativeDouble) , "StillEstimating" :: NullOrUndefined.NullOrUndefined (Boolean) , "LastRuntimeSeconds" :: NullOrUndefined.NullOrUndefined (NonNegativeDouble) , "MedianRuntimeSeconds" :: NullOrUndefined.NullOrUndefined (NonNegativeDouble) , "TablesCreated" :: NullOrUndefined.NullOrUndefined (NonNegativeInteger) , "TablesUpdated" :: NullOrUndefined.NullOrUndefined (NonNegativeInteger) , "TablesDeleted" :: NullOrUndefined.NullOrUndefined (NonNegativeInteger) } -> {"CrawlerName" :: NullOrUndefined.NullOrUndefined (NameString) , "TimeLeftSeconds" :: NullOrUndefined.NullOrUndefined (NonNegativeDouble) , "StillEstimating" :: NullOrUndefined.NullOrUndefined (Boolean) , "LastRuntimeSeconds" :: NullOrUndefined.NullOrUndefined (NonNegativeDouble) , "MedianRuntimeSeconds" :: NullOrUndefined.NullOrUndefined (NonNegativeDouble) , "TablesCreated" :: NullOrUndefined.NullOrUndefined (NonNegativeInteger) , "TablesUpdated" :: NullOrUndefined.NullOrUndefined (NonNegativeInteger) , "TablesDeleted" :: NullOrUndefined.NullOrUndefined (NonNegativeInteger) } ) -> CrawlerMetrics
...
--   This may be useful if you need to immediately overwrite some of the optional values
newCrawlerNotRunningException' :: ( { "Message" :: NullOrUndefined.NullOrUndefined (MessageString) } -> {"Message" :: NullOrUndefined.NullOrUndefined (MessageString) } ) -> CrawlerNotRunningException
...
--   This may be useful if you need to immediately overwrite some of the optional values
newCrawlerRunningException' :: ( { "Message" :: NullOrUndefined.NullOrUndefined (MessageString) } -> {"Message" :: NullOrUndefined.NullOrUndefined (MessageString) } ) -> CrawlerRunningException
...
--   This may be useful if you need to immediately overwrite some of the optional values
newCrawlerStoppingException' :: ( { "Message" :: NullOrUndefined.NullOrUndefined (MessageString) } -> {"Message" :: NullOrUndefined.NullOrUndefined (MessageString) } ) -> CrawlerStoppingException
...
--   This may be useful if you need to immediately overwrite some of the optional values
newCrawlerTargets' :: ( { "S3Targets" :: NullOrUndefined.NullOrUndefined (S3TargetList) , "JdbcTargets" :: NullOrUndefined.NullOrUndefined (JdbcTargetList) } -> {"S3Targets" :: NullOrUndefined.NullOrUndefined (S3TargetList) , "JdbcTargets" :: NullOrUndefined.NullOrUndefined (JdbcTargetList) } ) -> CrawlerTargets
...
--   This may be useful if you need to immediately overwrite some of the optional values
newCreateClassifierRequest' :: ( { "GrokClassifier" :: NullOrUndefined.NullOrUndefined (CreateGrokClassifierRequest) , "XMLClassifier" :: NullOrUndefined.NullOrUndefined (CreateXMLClassifierRequest) , "JsonClassifier" :: NullOrUndefined.NullOrUndefined (CreateJsonClassifierRequest) } -> {"GrokClassifier" :: NullOrUndefined.NullOrUndefined (CreateGrokClassifierRequest) , "XMLClassifier" :: NullOrUndefined.NullOrUndefined (CreateXMLClassifierRequest) , "JsonClassifier" :: NullOrUndefined.NullOrUndefined (CreateJsonClassifierRequest) } ) -> CreateClassifierRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newCreateConnectionRequest' :: ConnectionInput -> ( { "CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "ConnectionInput" :: (ConnectionInput) } -> {"CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "ConnectionInput" :: (ConnectionInput) } ) -> CreateConnectionRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newCreateCrawlerRequest' :: DatabaseName -> NameString -> Role -> CrawlerTargets -> ( { "Name" :: (NameString) , "Role" :: (Role) , "DatabaseName" :: (DatabaseName) , "Description" :: NullOrUndefined.NullOrUndefined (DescriptionString) , "Targets" :: (CrawlerTargets) , "Schedule" :: NullOrUndefined.NullOrUndefined (CronExpression) , "Classifiers" :: NullOrUndefined.NullOrUndefined (ClassifierNameList) , "TablePrefix" :: NullOrUndefined.NullOrUndefined (TablePrefix) , "SchemaChangePolicy" :: NullOrUndefined.NullOrUndefined (SchemaChangePolicy) , "Configuration" :: NullOrUndefined.NullOrUndefined (CrawlerConfiguration) } -> {"Name" :: (NameString) , "Role" :: (Role) , "DatabaseName" :: (DatabaseName) , "Description" :: NullOrUndefined.NullOrUndefined (DescriptionString) , "Targets" :: (CrawlerTargets) , "Schedule" :: NullOrUndefined.NullOrUndefined (CronExpression) , "Classifiers" :: NullOrUndefined.NullOrUndefined (ClassifierNameList) , "TablePrefix" :: NullOrUndefined.NullOrUndefined (TablePrefix) , "SchemaChangePolicy" :: NullOrUndefined.NullOrUndefined (SchemaChangePolicy) , "Configuration" :: NullOrUndefined.NullOrUndefined (CrawlerConfiguration) } ) -> CreateCrawlerRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newCreateDatabaseRequest' :: DatabaseInput -> ( { "CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "DatabaseInput" :: (DatabaseInput) } -> {"CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "DatabaseInput" :: (DatabaseInput) } ) -> CreateDatabaseRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newCreateDevEndpointRequest' :: GenericString -> GenericString -> RoleArn -> ( { "EndpointName" :: (GenericString) , "RoleArn" :: (RoleArn) , "SecurityGroupIds" :: NullOrUndefined.NullOrUndefined (StringList) , "SubnetId" :: NullOrUndefined.NullOrUndefined (GenericString) , "PublicKey" :: (GenericString) , "NumberOfNodes" :: NullOrUndefined.NullOrUndefined (IntegerValue) , "ExtraPythonLibsS3Path" :: NullOrUndefined.NullOrUndefined (GenericString) , "ExtraJarsS3Path" :: NullOrUndefined.NullOrUndefined (GenericString) } -> {"EndpointName" :: (GenericString) , "RoleArn" :: (RoleArn) , "SecurityGroupIds" :: NullOrUndefined.NullOrUndefined (StringList) , "SubnetId" :: NullOrUndefined.NullOrUndefined (GenericString) , "PublicKey" :: (GenericString) , "NumberOfNodes" :: NullOrUndefined.NullOrUndefined (IntegerValue) , "ExtraPythonLibsS3Path" :: NullOrUndefined.NullOrUndefined (GenericString) , "ExtraJarsS3Path" :: NullOrUndefined.NullOrUndefined (GenericString) } ) -> CreateDevEndpointRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newCreateDevEndpointResponse' :: ( { "EndpointName" :: NullOrUndefined.NullOrUndefined (GenericString) , "Status" :: NullOrUndefined.NullOrUndefined (GenericString) , "SecurityGroupIds" :: NullOrUndefined.NullOrUndefined (StringList) , "SubnetId" :: NullOrUndefined.NullOrUndefined (GenericString) , "RoleArn" :: NullOrUndefined.NullOrUndefined (RoleArn) , "YarnEndpointAddress" :: NullOrUndefined.NullOrUndefined (GenericString) , "ZeppelinRemoteSparkInterpreterPort" :: NullOrUndefined.NullOrUndefined (IntegerValue) , "NumberOfNodes" :: NullOrUndefined.NullOrUndefined (IntegerValue) , "AvailabilityZone" :: NullOrUndefined.NullOrUndefined (GenericString) , "VpcId" :: NullOrUndefined.NullOrUndefined (GenericString) , "ExtraPythonLibsS3Path" :: NullOrUndefined.NullOrUndefined (GenericString) , "ExtraJarsS3Path" :: NullOrUndefined.NullOrUndefined (GenericString) , "FailureReason" :: NullOrUndefined.NullOrUndefined (GenericString) , "CreatedTimestamp" :: NullOrUndefined.NullOrUndefined (TimestampValue) } -> {"EndpointName" :: NullOrUndefined.NullOrUndefined (GenericString) , "Status" :: NullOrUndefined.NullOrUndefined (GenericString) , "SecurityGroupIds" :: NullOrUndefined.NullOrUndefined (StringList) , "SubnetId" :: NullOrUndefined.NullOrUndefined (GenericString) , "RoleArn" :: NullOrUndefined.NullOrUndefined (RoleArn) , "YarnEndpointAddress" :: NullOrUndefined.NullOrUndefined (GenericString) , "ZeppelinRemoteSparkInterpreterPort" :: NullOrUndefined.NullOrUndefined (IntegerValue) , "NumberOfNodes" :: NullOrUndefined.NullOrUndefined (IntegerValue) , "AvailabilityZone" :: NullOrUndefined.NullOrUndefined (GenericString) , "VpcId" :: NullOrUndefined.NullOrUndefined (GenericString) , "ExtraPythonLibsS3Path" :: NullOrUndefined.NullOrUndefined (GenericString) , "ExtraJarsS3Path" :: NullOrUndefined.NullOrUndefined (GenericString) , "FailureReason" :: NullOrUndefined.NullOrUndefined (GenericString) , "CreatedTimestamp" :: NullOrUndefined.NullOrUndefined (TimestampValue) } ) -> CreateDevEndpointResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newCreateGrokClassifierRequest' :: Classification -> GrokPattern -> NameString -> ( { "Classification" :: (Classification) , "Name" :: (NameString) , "GrokPattern" :: (GrokPattern) , "CustomPatterns" :: NullOrUndefined.NullOrUndefined (CustomPatterns) } -> {"Classification" :: (Classification) , "Name" :: (NameString) , "GrokPattern" :: (GrokPattern) , "CustomPatterns" :: NullOrUndefined.NullOrUndefined (CustomPatterns) } ) -> CreateGrokClassifierRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newCreateJobRequest' :: JobCommand -> NameString -> RoleString -> ( { "Name" :: (NameString) , "Description" :: NullOrUndefined.NullOrUndefined (DescriptionString) , "LogUri" :: NullOrUndefined.NullOrUndefined (UriString) , "Role" :: (RoleString) , "ExecutionProperty" :: NullOrUndefined.NullOrUndefined (ExecutionProperty) , "Command" :: (JobCommand) , "DefaultArguments" :: NullOrUndefined.NullOrUndefined (GenericMap) , "Connections" :: NullOrUndefined.NullOrUndefined (ConnectionsList) , "MaxRetries" :: NullOrUndefined.NullOrUndefined (MaxRetries) , "AllocatedCapacity" :: NullOrUndefined.NullOrUndefined (IntegerValue) } -> {"Name" :: (NameString) , "Description" :: NullOrUndefined.NullOrUndefined (DescriptionString) , "LogUri" :: NullOrUndefined.NullOrUndefined (UriString) , "Role" :: (RoleString) , "ExecutionProperty" :: NullOrUndefined.NullOrUndefined (ExecutionProperty) , "Command" :: (JobCommand) , "DefaultArguments" :: NullOrUndefined.NullOrUndefined (GenericMap) , "Connections" :: NullOrUndefined.NullOrUndefined (ConnectionsList) , "MaxRetries" :: NullOrUndefined.NullOrUndefined (MaxRetries) , "AllocatedCapacity" :: NullOrUndefined.NullOrUndefined (IntegerValue) } ) -> CreateJobRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newCreateJobResponse' :: ( { "Name" :: NullOrUndefined.NullOrUndefined (NameString) } -> {"Name" :: NullOrUndefined.NullOrUndefined (NameString) } ) -> CreateJobResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newCreatePartitionRequest' :: NameString -> PartitionInput -> NameString -> ( { "CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "DatabaseName" :: (NameString) , "TableName" :: (NameString) , "PartitionInput" :: (PartitionInput) } -> {"CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "DatabaseName" :: (NameString) , "TableName" :: (NameString) , "PartitionInput" :: (PartitionInput) } ) -> CreatePartitionRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newCreateScriptRequest' :: ( { "DagNodes" :: NullOrUndefined.NullOrUndefined (DagNodes) , "DagEdges" :: NullOrUndefined.NullOrUndefined (DagEdges) , "Language" :: NullOrUndefined.NullOrUndefined (Language) } -> {"DagNodes" :: NullOrUndefined.NullOrUndefined (DagNodes) , "DagEdges" :: NullOrUndefined.NullOrUndefined (DagEdges) , "Language" :: NullOrUndefined.NullOrUndefined (Language) } ) -> CreateScriptRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newCreateScriptResponse' :: ( { "PythonScript" :: NullOrUndefined.NullOrUndefined (PythonScript) , "ScalaCode" :: NullOrUndefined.NullOrUndefined (ScalaCode) } -> {"PythonScript" :: NullOrUndefined.NullOrUndefined (PythonScript) , "ScalaCode" :: NullOrUndefined.NullOrUndefined (ScalaCode) } ) -> CreateScriptResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newCreateTableRequest' :: NameString -> TableInput -> ( { "CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "DatabaseName" :: (NameString) , "TableInput" :: (TableInput) } -> {"CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "DatabaseName" :: (NameString) , "TableInput" :: (TableInput) } ) -> CreateTableRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newCreateTriggerRequest' :: ActionList -> NameString -> TriggerType -> ( { "Name" :: (NameString) , "Type" :: (TriggerType) , "Schedule" :: NullOrUndefined.NullOrUndefined (GenericString) , "Predicate" :: NullOrUndefined.NullOrUndefined (Predicate) , "Actions" :: (ActionList) , "Description" :: NullOrUndefined.NullOrUndefined (DescriptionString) } -> {"Name" :: (NameString) , "Type" :: (TriggerType) , "Schedule" :: NullOrUndefined.NullOrUndefined (GenericString) , "Predicate" :: NullOrUndefined.NullOrUndefined (Predicate) , "Actions" :: (ActionList) , "Description" :: NullOrUndefined.NullOrUndefined (DescriptionString) } ) -> CreateTriggerRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newCreateTriggerResponse' :: ( { "Name" :: NullOrUndefined.NullOrUndefined (NameString) } -> {"Name" :: NullOrUndefined.NullOrUndefined (NameString) } ) -> CreateTriggerResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newCreateXMLClassifierRequest' :: Classification -> NameString -> ( { "Classification" :: (Classification) , "Name" :: (NameString) , "RowTag" :: NullOrUndefined.NullOrUndefined (RowTag) } -> {"Classification" :: (Classification) , "Name" :: (NameString) , "RowTag" :: NullOrUndefined.NullOrUndefined (RowTag) } ) -> CreateXMLClassifierRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newDatabase' :: NameString -> ( { "Name" :: (NameString) , "Description" :: NullOrUndefined.NullOrUndefined (DescriptionString) , "LocationUri" :: NullOrUndefined.NullOrUndefined (URI) , "Parameters" :: NullOrUndefined.NullOrUndefined (ParametersMap) , "CreateTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) } -> {"Name" :: (NameString) , "Description" :: NullOrUndefined.NullOrUndefined (DescriptionString) , "LocationUri" :: NullOrUndefined.NullOrUndefined (URI) , "Parameters" :: NullOrUndefined.NullOrUndefined (ParametersMap) , "CreateTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) } ) -> Database
...
--   This may be useful if you need to immediately overwrite some of the optional values
newDatabaseInput' :: NameString -> ( { "Name" :: (NameString) , "Description" :: NullOrUndefined.NullOrUndefined (DescriptionString) , "LocationUri" :: NullOrUndefined.NullOrUndefined (URI) , "Parameters" :: NullOrUndefined.NullOrUndefined (ParametersMap) } -> {"Name" :: (NameString) , "Description" :: NullOrUndefined.NullOrUndefined (DescriptionString) , "LocationUri" :: NullOrUndefined.NullOrUndefined (URI) , "Parameters" :: NullOrUndefined.NullOrUndefined (ParametersMap) } ) -> DatabaseInput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newDeleteConnectionRequest' :: NameString -> ( { "CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "ConnectionName" :: (NameString) } -> {"CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "ConnectionName" :: (NameString) } ) -> DeleteConnectionRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newDeleteDatabaseRequest' :: NameString -> ( { "CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "Name" :: (NameString) } -> {"CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "Name" :: (NameString) } ) -> DeleteDatabaseRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newDeleteJobResponse' :: ( { "JobName" :: NullOrUndefined.NullOrUndefined (NameString) } -> {"JobName" :: NullOrUndefined.NullOrUndefined (NameString) } ) -> DeleteJobResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newDeletePartitionRequest' :: NameString -> ValueStringList -> NameString -> ( { "CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "DatabaseName" :: (NameString) , "TableName" :: (NameString) , "PartitionValues" :: (ValueStringList) } -> {"CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "DatabaseName" :: (NameString) , "TableName" :: (NameString) , "PartitionValues" :: (ValueStringList) } ) -> DeletePartitionRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newDeleteTableRequest' :: NameString -> NameString -> ( { "CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "DatabaseName" :: (NameString) , "Name" :: (NameString) } -> {"CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "DatabaseName" :: (NameString) , "Name" :: (NameString) } ) -> DeleteTableRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newDeleteTableVersionRequest' :: NameString -> NameString -> VersionString -> ( { "CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "DatabaseName" :: (NameString) , "TableName" :: (NameString) , "VersionId" :: (VersionString) } -> {"CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "DatabaseName" :: (NameString) , "TableName" :: (NameString) , "VersionId" :: (VersionString) } ) -> DeleteTableVersionRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newDeleteTriggerResponse' :: ( { "Name" :: NullOrUndefined.NullOrUndefined (NameString) } -> {"Name" :: NullOrUndefined.NullOrUndefined (NameString) } ) -> DeleteTriggerResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newDeleteUserDefinedFunctionRequest' :: NameString -> NameString -> ( { "CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "DatabaseName" :: (NameString) , "FunctionName" :: (NameString) } -> {"CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "DatabaseName" :: (NameString) , "FunctionName" :: (NameString) } ) -> DeleteUserDefinedFunctionRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newDevEndpoint' :: ( { "EndpointName" :: NullOrUndefined.NullOrUndefined (GenericString) , "RoleArn" :: NullOrUndefined.NullOrUndefined (RoleArn) , "SecurityGroupIds" :: NullOrUndefined.NullOrUndefined (StringList) , "SubnetId" :: NullOrUndefined.NullOrUndefined (GenericString) , "YarnEndpointAddress" :: NullOrUndefined.NullOrUndefined (GenericString) , "ZeppelinRemoteSparkInterpreterPort" :: NullOrUndefined.NullOrUndefined (IntegerValue) , "PublicAddress" :: NullOrUndefined.NullOrUndefined (GenericString) , "Status" :: NullOrUndefined.NullOrUndefined (GenericString) , "NumberOfNodes" :: NullOrUndefined.NullOrUndefined (IntegerValue) , "AvailabilityZone" :: NullOrUndefined.NullOrUndefined (GenericString) , "VpcId" :: NullOrUndefined.NullOrUndefined (GenericString) , "ExtraPythonLibsS3Path" :: NullOrUndefined.NullOrUndefined (GenericString) , "ExtraJarsS3Path" :: NullOrUndefined.NullOrUndefined (GenericString) , "FailureReason" :: NullOrUndefined.NullOrUndefined (GenericString) , "LastUpdateStatus" :: NullOrUndefined.NullOrUndefined (GenericString) , "CreatedTimestamp" :: NullOrUndefined.NullOrUndefined (TimestampValue) , "LastModifiedTimestamp" :: NullOrUndefined.NullOrUndefined (TimestampValue) , "PublicKey" :: NullOrUndefined.NullOrUndefined (GenericString) } -> {"EndpointName" :: NullOrUndefined.NullOrUndefined (GenericString) , "RoleArn" :: NullOrUndefined.NullOrUndefined (RoleArn) , "SecurityGroupIds" :: NullOrUndefined.NullOrUndefined (StringList) , "SubnetId" :: NullOrUndefined.NullOrUndefined (GenericString) , "YarnEndpointAddress" :: NullOrUndefined.NullOrUndefined (GenericString) , "ZeppelinRemoteSparkInterpreterPort" :: NullOrUndefined.NullOrUndefined (IntegerValue) , "PublicAddress" :: NullOrUndefined.NullOrUndefined (GenericString) , "Status" :: NullOrUndefined.NullOrUndefined (GenericString) , "NumberOfNodes" :: NullOrUndefined.NullOrUndefined (IntegerValue) , "AvailabilityZone" :: NullOrUndefined.NullOrUndefined (GenericString) , "VpcId" :: NullOrUndefined.NullOrUndefined (GenericString) , "ExtraPythonLibsS3Path" :: NullOrUndefined.NullOrUndefined (GenericString) , "ExtraJarsS3Path" :: NullOrUndefined.NullOrUndefined (GenericString) , "FailureReason" :: NullOrUndefined.NullOrUndefined (GenericString) , "LastUpdateStatus" :: NullOrUndefined.NullOrUndefined (GenericString) , "CreatedTimestamp" :: NullOrUndefined.NullOrUndefined (TimestampValue) , "LastModifiedTimestamp" :: NullOrUndefined.NullOrUndefined (TimestampValue) , "PublicKey" :: NullOrUndefined.NullOrUndefined (GenericString) } ) -> DevEndpoint
...
--   This may be useful if you need to immediately overwrite some of the optional values
newDevEndpointCustomLibraries' :: ( { "ExtraPythonLibsS3Path" :: NullOrUndefined.NullOrUndefined (GenericString) , "ExtraJarsS3Path" :: NullOrUndefined.NullOrUndefined (GenericString) } -> {"ExtraPythonLibsS3Path" :: NullOrUndefined.NullOrUndefined (GenericString) , "ExtraJarsS3Path" :: NullOrUndefined.NullOrUndefined (GenericString) } ) -> DevEndpointCustomLibraries
...
--   This may be useful if you need to immediately overwrite some of the optional values
newEntityNotFoundException' :: ( { "Message" :: NullOrUndefined.NullOrUndefined (MessageString) } -> {"Message" :: NullOrUndefined.NullOrUndefined (MessageString) } ) -> EntityNotFoundException
...
--   This may be useful if you need to immediately overwrite some of the optional values
newErrorDetail' :: ( { "ErrorCode" :: NullOrUndefined.NullOrUndefined (NameString) , "ErrorMessage" :: NullOrUndefined.NullOrUndefined (DescriptionString) } -> {"ErrorCode" :: NullOrUndefined.NullOrUndefined (NameString) , "ErrorMessage" :: NullOrUndefined.NullOrUndefined (DescriptionString) } ) -> ErrorDetail
...
--   This may be useful if you need to immediately overwrite some of the optional values
newExecutionProperty' :: ( { "MaxConcurrentRuns" :: NullOrUndefined.NullOrUndefined (MaxConcurrentRuns) } -> {"MaxConcurrentRuns" :: NullOrUndefined.NullOrUndefined (MaxConcurrentRuns) } ) -> ExecutionProperty
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetCatalogImportStatusRequest' :: ( { "CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) } -> {"CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) } ) -> GetCatalogImportStatusRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetCatalogImportStatusResponse' :: ( { "ImportStatus" :: NullOrUndefined.NullOrUndefined (CatalogImportStatus) } -> {"ImportStatus" :: NullOrUndefined.NullOrUndefined (CatalogImportStatus) } ) -> GetCatalogImportStatusResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetClassifierResponse' :: ( { "Classifier" :: NullOrUndefined.NullOrUndefined (Classifier) } -> {"Classifier" :: NullOrUndefined.NullOrUndefined (Classifier) } ) -> GetClassifierResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetClassifiersRequest' :: ( { "MaxResults" :: NullOrUndefined.NullOrUndefined (PageSize) , "NextToken" :: NullOrUndefined.NullOrUndefined (Token) } -> {"MaxResults" :: NullOrUndefined.NullOrUndefined (PageSize) , "NextToken" :: NullOrUndefined.NullOrUndefined (Token) } ) -> GetClassifiersRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetClassifiersResponse' :: ( { "Classifiers" :: NullOrUndefined.NullOrUndefined (ClassifierList) , "NextToken" :: NullOrUndefined.NullOrUndefined (Token) } -> {"Classifiers" :: NullOrUndefined.NullOrUndefined (ClassifierList) , "NextToken" :: NullOrUndefined.NullOrUndefined (Token) } ) -> GetClassifiersResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetConnectionRequest' :: NameString -> ( { "CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "Name" :: (NameString) } -> {"CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "Name" :: (NameString) } ) -> GetConnectionRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetConnectionResponse' :: ( { "Connection" :: NullOrUndefined.NullOrUndefined (Connection) } -> {"Connection" :: NullOrUndefined.NullOrUndefined (Connection) } ) -> GetConnectionResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetConnectionsFilter' :: ( { "MatchCriteria" :: NullOrUndefined.NullOrUndefined (MatchCriteria) , "ConnectionType" :: NullOrUndefined.NullOrUndefined (ConnectionType) } -> {"MatchCriteria" :: NullOrUndefined.NullOrUndefined (MatchCriteria) , "ConnectionType" :: NullOrUndefined.NullOrUndefined (ConnectionType) } ) -> GetConnectionsFilter
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetConnectionsRequest' :: ( { "CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "Filter" :: NullOrUndefined.NullOrUndefined (GetConnectionsFilter) , "NextToken" :: NullOrUndefined.NullOrUndefined (Token) , "MaxResults" :: NullOrUndefined.NullOrUndefined (PageSize) } -> {"CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "Filter" :: NullOrUndefined.NullOrUndefined (GetConnectionsFilter) , "NextToken" :: NullOrUndefined.NullOrUndefined (Token) , "MaxResults" :: NullOrUndefined.NullOrUndefined (PageSize) } ) -> GetConnectionsRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetConnectionsResponse' :: ( { "ConnectionList" :: NullOrUndefined.NullOrUndefined (ConnectionList) , "NextToken" :: NullOrUndefined.NullOrUndefined (Token) } -> {"ConnectionList" :: NullOrUndefined.NullOrUndefined (ConnectionList) , "NextToken" :: NullOrUndefined.NullOrUndefined (Token) } ) -> GetConnectionsResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetCrawlerMetricsRequest' :: ( { "CrawlerNameList" :: NullOrUndefined.NullOrUndefined (CrawlerNameList) , "MaxResults" :: NullOrUndefined.NullOrUndefined (PageSize) , "NextToken" :: NullOrUndefined.NullOrUndefined (Token) } -> {"CrawlerNameList" :: NullOrUndefined.NullOrUndefined (CrawlerNameList) , "MaxResults" :: NullOrUndefined.NullOrUndefined (PageSize) , "NextToken" :: NullOrUndefined.NullOrUndefined (Token) } ) -> GetCrawlerMetricsRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetCrawlerMetricsResponse' :: ( { "CrawlerMetricsList" :: NullOrUndefined.NullOrUndefined (CrawlerMetricsList) , "NextToken" :: NullOrUndefined.NullOrUndefined (Token) } -> {"CrawlerMetricsList" :: NullOrUndefined.NullOrUndefined (CrawlerMetricsList) , "NextToken" :: NullOrUndefined.NullOrUndefined (Token) } ) -> GetCrawlerMetricsResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetCrawlerResponse' :: ( { "Crawler" :: NullOrUndefined.NullOrUndefined (Crawler) } -> {"Crawler" :: NullOrUndefined.NullOrUndefined (Crawler) } ) -> GetCrawlerResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetCrawlersRequest' :: ( { "MaxResults" :: NullOrUndefined.NullOrUndefined (PageSize) , "NextToken" :: NullOrUndefined.NullOrUndefined (Token) } -> {"MaxResults" :: NullOrUndefined.NullOrUndefined (PageSize) , "NextToken" :: NullOrUndefined.NullOrUndefined (Token) } ) -> GetCrawlersRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetCrawlersResponse' :: ( { "Crawlers" :: NullOrUndefined.NullOrUndefined (CrawlerList) , "NextToken" :: NullOrUndefined.NullOrUndefined (Token) } -> {"Crawlers" :: NullOrUndefined.NullOrUndefined (CrawlerList) , "NextToken" :: NullOrUndefined.NullOrUndefined (Token) } ) -> GetCrawlersResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetDatabaseRequest' :: NameString -> ( { "CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "Name" :: (NameString) } -> {"CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "Name" :: (NameString) } ) -> GetDatabaseRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetDatabaseResponse' :: ( { "Database" :: NullOrUndefined.NullOrUndefined (Database) } -> {"Database" :: NullOrUndefined.NullOrUndefined (Database) } ) -> GetDatabaseResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetDatabasesRequest' :: ( { "CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "NextToken" :: NullOrUndefined.NullOrUndefined (Token) , "MaxResults" :: NullOrUndefined.NullOrUndefined (PageSize) } -> {"CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "NextToken" :: NullOrUndefined.NullOrUndefined (Token) , "MaxResults" :: NullOrUndefined.NullOrUndefined (PageSize) } ) -> GetDatabasesRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetDatabasesResponse' :: DatabaseList -> ( { "DatabaseList" :: (DatabaseList) , "NextToken" :: NullOrUndefined.NullOrUndefined (Token) } -> {"DatabaseList" :: (DatabaseList) , "NextToken" :: NullOrUndefined.NullOrUndefined (Token) } ) -> GetDatabasesResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetDataflowGraphRequest' :: ( { "PythonScript" :: NullOrUndefined.NullOrUndefined (PythonScript) } -> {"PythonScript" :: NullOrUndefined.NullOrUndefined (PythonScript) } ) -> GetDataflowGraphRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetDataflowGraphResponse' :: ( { "DagNodes" :: NullOrUndefined.NullOrUndefined (DagNodes) , "DagEdges" :: NullOrUndefined.NullOrUndefined (DagEdges) } -> {"DagNodes" :: NullOrUndefined.NullOrUndefined (DagNodes) , "DagEdges" :: NullOrUndefined.NullOrUndefined (DagEdges) } ) -> GetDataflowGraphResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetDevEndpointResponse' :: ( { "DevEndpoint" :: NullOrUndefined.NullOrUndefined (DevEndpoint) } -> {"DevEndpoint" :: NullOrUndefined.NullOrUndefined (DevEndpoint) } ) -> GetDevEndpointResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetDevEndpointsRequest' :: ( { "MaxResults" :: NullOrUndefined.NullOrUndefined (PageSize) , "NextToken" :: NullOrUndefined.NullOrUndefined (GenericString) } -> {"MaxResults" :: NullOrUndefined.NullOrUndefined (PageSize) , "NextToken" :: NullOrUndefined.NullOrUndefined (GenericString) } ) -> GetDevEndpointsRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetDevEndpointsResponse' :: ( { "DevEndpoints" :: NullOrUndefined.NullOrUndefined (DevEndpointList) , "NextToken" :: NullOrUndefined.NullOrUndefined (GenericString) } -> {"DevEndpoints" :: NullOrUndefined.NullOrUndefined (DevEndpointList) , "NextToken" :: NullOrUndefined.NullOrUndefined (GenericString) } ) -> GetDevEndpointsResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetJobRunRequest' :: NameString -> IdString -> ( { "JobName" :: (NameString) , "RunId" :: (IdString) , "PredecessorsIncluded" :: NullOrUndefined.NullOrUndefined (BooleanValue) } -> {"JobName" :: (NameString) , "RunId" :: (IdString) , "PredecessorsIncluded" :: NullOrUndefined.NullOrUndefined (BooleanValue) } ) -> GetJobRunRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetJobRunResponse' :: ( { "JobRun" :: NullOrUndefined.NullOrUndefined (JobRun) } -> {"JobRun" :: NullOrUndefined.NullOrUndefined (JobRun) } ) -> GetJobRunResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetJobRunsRequest' :: NameString -> ( { "JobName" :: (NameString) , "NextToken" :: NullOrUndefined.NullOrUndefined (GenericString) , "MaxResults" :: NullOrUndefined.NullOrUndefined (PageSize) } -> {"JobName" :: (NameString) , "NextToken" :: NullOrUndefined.NullOrUndefined (GenericString) , "MaxResults" :: NullOrUndefined.NullOrUndefined (PageSize) } ) -> GetJobRunsRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetJobRunsResponse' :: ( { "JobRuns" :: NullOrUndefined.NullOrUndefined (JobRunList) , "NextToken" :: NullOrUndefined.NullOrUndefined (GenericString) } -> {"JobRuns" :: NullOrUndefined.NullOrUndefined (JobRunList) , "NextToken" :: NullOrUndefined.NullOrUndefined (GenericString) } ) -> GetJobRunsResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetJobsRequest' :: ( { "NextToken" :: NullOrUndefined.NullOrUndefined (GenericString) , "MaxResults" :: NullOrUndefined.NullOrUndefined (PageSize) } -> {"NextToken" :: NullOrUndefined.NullOrUndefined (GenericString) , "MaxResults" :: NullOrUndefined.NullOrUndefined (PageSize) } ) -> GetJobsRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetJobsResponse' :: ( { "Jobs" :: NullOrUndefined.NullOrUndefined (JobList) , "NextToken" :: NullOrUndefined.NullOrUndefined (GenericString) } -> {"Jobs" :: NullOrUndefined.NullOrUndefined (JobList) , "NextToken" :: NullOrUndefined.NullOrUndefined (GenericString) } ) -> GetJobsResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetMappingRequest' :: CatalogEntry -> ( { "Source" :: (CatalogEntry) , "Sinks" :: NullOrUndefined.NullOrUndefined (CatalogEntries) , "Location" :: NullOrUndefined.NullOrUndefined (Location) } -> {"Source" :: (CatalogEntry) , "Sinks" :: NullOrUndefined.NullOrUndefined (CatalogEntries) , "Location" :: NullOrUndefined.NullOrUndefined (Location) } ) -> GetMappingRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetPartitionRequest' :: NameString -> ValueStringList -> NameString -> ( { "CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "DatabaseName" :: (NameString) , "TableName" :: (NameString) , "PartitionValues" :: (ValueStringList) } -> {"CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "DatabaseName" :: (NameString) , "TableName" :: (NameString) , "PartitionValues" :: (ValueStringList) } ) -> GetPartitionRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetPartitionResponse' :: ( { "Partition" :: NullOrUndefined.NullOrUndefined (Partition) } -> {"Partition" :: NullOrUndefined.NullOrUndefined (Partition) } ) -> GetPartitionResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetPartitionsRequest' :: NameString -> NameString -> ( { "CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "DatabaseName" :: (NameString) , "TableName" :: (NameString) , "Expression" :: NullOrUndefined.NullOrUndefined (PredicateString) , "NextToken" :: NullOrUndefined.NullOrUndefined (Token) , "Segment" :: NullOrUndefined.NullOrUndefined (Segment) , "MaxResults" :: NullOrUndefined.NullOrUndefined (PageSize) } -> {"CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "DatabaseName" :: (NameString) , "TableName" :: (NameString) , "Expression" :: NullOrUndefined.NullOrUndefined (PredicateString) , "NextToken" :: NullOrUndefined.NullOrUndefined (Token) , "Segment" :: NullOrUndefined.NullOrUndefined (Segment) , "MaxResults" :: NullOrUndefined.NullOrUndefined (PageSize) } ) -> GetPartitionsRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetPartitionsResponse' :: ( { "Partitions" :: NullOrUndefined.NullOrUndefined (PartitionList) , "NextToken" :: NullOrUndefined.NullOrUndefined (Token) } -> {"Partitions" :: NullOrUndefined.NullOrUndefined (PartitionList) , "NextToken" :: NullOrUndefined.NullOrUndefined (Token) } ) -> GetPartitionsResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetPlanRequest' :: MappingList -> CatalogEntry -> ( { "Mapping" :: (MappingList) , "Source" :: (CatalogEntry) , "Sinks" :: NullOrUndefined.NullOrUndefined (CatalogEntries) , "Location" :: NullOrUndefined.NullOrUndefined (Location) , "Language" :: NullOrUndefined.NullOrUndefined (Language) } -> {"Mapping" :: (MappingList) , "Source" :: (CatalogEntry) , "Sinks" :: NullOrUndefined.NullOrUndefined (CatalogEntries) , "Location" :: NullOrUndefined.NullOrUndefined (Location) , "Language" :: NullOrUndefined.NullOrUndefined (Language) } ) -> GetPlanRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetPlanResponse' :: ( { "PythonScript" :: NullOrUndefined.NullOrUndefined (PythonScript) , "ScalaCode" :: NullOrUndefined.NullOrUndefined (ScalaCode) } -> {"PythonScript" :: NullOrUndefined.NullOrUndefined (PythonScript) , "ScalaCode" :: NullOrUndefined.NullOrUndefined (ScalaCode) } ) -> GetPlanResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetTableRequest' :: NameString -> NameString -> ( { "CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "DatabaseName" :: (NameString) , "Name" :: (NameString) } -> {"CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "DatabaseName" :: (NameString) , "Name" :: (NameString) } ) -> GetTableRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetTableResponse' :: ( { "Table" :: NullOrUndefined.NullOrUndefined (Table) } -> {"Table" :: NullOrUndefined.NullOrUndefined (Table) } ) -> GetTableResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetTableVersionRequest' :: NameString -> NameString -> ( { "CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "DatabaseName" :: (NameString) , "TableName" :: (NameString) , "VersionId" :: NullOrUndefined.NullOrUndefined (VersionString) } -> {"CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "DatabaseName" :: (NameString) , "TableName" :: (NameString) , "VersionId" :: NullOrUndefined.NullOrUndefined (VersionString) } ) -> GetTableVersionRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetTableVersionResponse' :: ( { "TableVersion" :: NullOrUndefined.NullOrUndefined (TableVersion) } -> {"TableVersion" :: NullOrUndefined.NullOrUndefined (TableVersion) } ) -> GetTableVersionResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetTableVersionsRequest' :: NameString -> NameString -> ( { "CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "DatabaseName" :: (NameString) , "TableName" :: (NameString) , "NextToken" :: NullOrUndefined.NullOrUndefined (Token) , "MaxResults" :: NullOrUndefined.NullOrUndefined (PageSize) } -> {"CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "DatabaseName" :: (NameString) , "TableName" :: (NameString) , "NextToken" :: NullOrUndefined.NullOrUndefined (Token) , "MaxResults" :: NullOrUndefined.NullOrUndefined (PageSize) } ) -> GetTableVersionsRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetTableVersionsResponse' :: ( { "TableVersions" :: NullOrUndefined.NullOrUndefined (GetTableVersionsList) , "NextToken" :: NullOrUndefined.NullOrUndefined (Token) } -> {"TableVersions" :: NullOrUndefined.NullOrUndefined (GetTableVersionsList) , "NextToken" :: NullOrUndefined.NullOrUndefined (Token) } ) -> GetTableVersionsResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetTablesRequest' :: NameString -> ( { "CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "DatabaseName" :: (NameString) , "Expression" :: NullOrUndefined.NullOrUndefined (FilterString) , "NextToken" :: NullOrUndefined.NullOrUndefined (Token) , "MaxResults" :: NullOrUndefined.NullOrUndefined (PageSize) } -> {"CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "DatabaseName" :: (NameString) , "Expression" :: NullOrUndefined.NullOrUndefined (FilterString) , "NextToken" :: NullOrUndefined.NullOrUndefined (Token) , "MaxResults" :: NullOrUndefined.NullOrUndefined (PageSize) } ) -> GetTablesRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetTablesResponse' :: ( { "TableList" :: NullOrUndefined.NullOrUndefined (TableList) , "NextToken" :: NullOrUndefined.NullOrUndefined (Token) } -> {"TableList" :: NullOrUndefined.NullOrUndefined (TableList) , "NextToken" :: NullOrUndefined.NullOrUndefined (Token) } ) -> GetTablesResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetTriggerResponse' :: ( { "Trigger" :: NullOrUndefined.NullOrUndefined (Trigger) } -> {"Trigger" :: NullOrUndefined.NullOrUndefined (Trigger) } ) -> GetTriggerResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetTriggersRequest' :: ( { "NextToken" :: NullOrUndefined.NullOrUndefined (GenericString) , "DependentJobName" :: NullOrUndefined.NullOrUndefined (NameString) , "MaxResults" :: NullOrUndefined.NullOrUndefined (PageSize) } -> {"NextToken" :: NullOrUndefined.NullOrUndefined (GenericString) , "DependentJobName" :: NullOrUndefined.NullOrUndefined (NameString) , "MaxResults" :: NullOrUndefined.NullOrUndefined (PageSize) } ) -> GetTriggersRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetTriggersResponse' :: ( { "Triggers" :: NullOrUndefined.NullOrUndefined (TriggerList) , "NextToken" :: NullOrUndefined.NullOrUndefined (GenericString) } -> {"Triggers" :: NullOrUndefined.NullOrUndefined (TriggerList) , "NextToken" :: NullOrUndefined.NullOrUndefined (GenericString) } ) -> GetTriggersResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetUserDefinedFunctionRequest' :: NameString -> NameString -> ( { "CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "DatabaseName" :: (NameString) , "FunctionName" :: (NameString) } -> {"CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "DatabaseName" :: (NameString) , "FunctionName" :: (NameString) } ) -> GetUserDefinedFunctionRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetUserDefinedFunctionResponse' :: ( { "UserDefinedFunction" :: NullOrUndefined.NullOrUndefined (UserDefinedFunction) } -> {"UserDefinedFunction" :: NullOrUndefined.NullOrUndefined (UserDefinedFunction) } ) -> GetUserDefinedFunctionResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetUserDefinedFunctionsRequest' :: NameString -> NameString -> ( { "CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "DatabaseName" :: (NameString) , "Pattern" :: (NameString) , "NextToken" :: NullOrUndefined.NullOrUndefined (Token) , "MaxResults" :: NullOrUndefined.NullOrUndefined (PageSize) } -> {"CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "DatabaseName" :: (NameString) , "Pattern" :: (NameString) , "NextToken" :: NullOrUndefined.NullOrUndefined (Token) , "MaxResults" :: NullOrUndefined.NullOrUndefined (PageSize) } ) -> GetUserDefinedFunctionsRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGetUserDefinedFunctionsResponse' :: ( { "UserDefinedFunctions" :: NullOrUndefined.NullOrUndefined (UserDefinedFunctionList) , "NextToken" :: NullOrUndefined.NullOrUndefined (Token) } -> {"UserDefinedFunctions" :: NullOrUndefined.NullOrUndefined (UserDefinedFunctionList) , "NextToken" :: NullOrUndefined.NullOrUndefined (Token) } ) -> GetUserDefinedFunctionsResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newGrokClassifier' :: Classification -> GrokPattern -> NameString -> ( { "Name" :: (NameString) , "Classification" :: (Classification) , "CreationTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "LastUpdated" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "Version" :: NullOrUndefined.NullOrUndefined (VersionId) , "GrokPattern" :: (GrokPattern) , "CustomPatterns" :: NullOrUndefined.NullOrUndefined (CustomPatterns) } -> {"Name" :: (NameString) , "Classification" :: (Classification) , "CreationTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "LastUpdated" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "Version" :: NullOrUndefined.NullOrUndefined (VersionId) , "GrokPattern" :: (GrokPattern) , "CustomPatterns" :: NullOrUndefined.NullOrUndefined (CustomPatterns) } ) -> GrokClassifier
...
--   This may be useful if you need to immediately overwrite some of the optional values
newIdempotentParameterMismatchException' :: ( { "Message" :: NullOrUndefined.NullOrUndefined (MessageString) } -> {"Message" :: NullOrUndefined.NullOrUndefined (MessageString) } ) -> IdempotentParameterMismatchException
...
--   This may be useful if you need to immediately overwrite some of the optional values
newImportCatalogToGlueRequest' :: ( { "CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) } -> {"CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) } ) -> ImportCatalogToGlueRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newInternalServiceException' :: ( { "Message" :: NullOrUndefined.NullOrUndefined (MessageString) } -> {"Message" :: NullOrUndefined.NullOrUndefined (MessageString) } ) -> InternalServiceException
...
--   This may be useful if you need to immediately overwrite some of the optional values
newInvalidInputException' :: ( { "Message" :: NullOrUndefined.NullOrUndefined (MessageString) } -> {"Message" :: NullOrUndefined.NullOrUndefined (MessageString) } ) -> InvalidInputException
...
--   This may be useful if you need to immediately overwrite some of the optional values
newJdbcTarget' :: ( { "ConnectionName" :: NullOrUndefined.NullOrUndefined (ConnectionName) , "Path" :: NullOrUndefined.NullOrUndefined (Path) , "Exclusions" :: NullOrUndefined.NullOrUndefined (PathList) } -> {"ConnectionName" :: NullOrUndefined.NullOrUndefined (ConnectionName) , "Path" :: NullOrUndefined.NullOrUndefined (Path) , "Exclusions" :: NullOrUndefined.NullOrUndefined (PathList) } ) -> JdbcTarget
...
--   This may be useful if you need to immediately overwrite some of the optional values
newJob' :: ( { "Name" :: NullOrUndefined.NullOrUndefined (NameString) , "Description" :: NullOrUndefined.NullOrUndefined (DescriptionString) , "LogUri" :: NullOrUndefined.NullOrUndefined (UriString) , "Role" :: NullOrUndefined.NullOrUndefined (RoleString) , "CreatedOn" :: NullOrUndefined.NullOrUndefined (TimestampValue) , "LastModifiedOn" :: NullOrUndefined.NullOrUndefined (TimestampValue) , "ExecutionProperty" :: NullOrUndefined.NullOrUndefined (ExecutionProperty) , "Command" :: NullOrUndefined.NullOrUndefined (JobCommand) , "DefaultArguments" :: NullOrUndefined.NullOrUndefined (GenericMap) , "Connections" :: NullOrUndefined.NullOrUndefined (ConnectionsList) , "MaxRetries" :: NullOrUndefined.NullOrUndefined (MaxRetries) , "AllocatedCapacity" :: NullOrUndefined.NullOrUndefined (IntegerValue) } -> {"Name" :: NullOrUndefined.NullOrUndefined (NameString) , "Description" :: NullOrUndefined.NullOrUndefined (DescriptionString) , "LogUri" :: NullOrUndefined.NullOrUndefined (UriString) , "Role" :: NullOrUndefined.NullOrUndefined (RoleString) , "CreatedOn" :: NullOrUndefined.NullOrUndefined (TimestampValue) , "LastModifiedOn" :: NullOrUndefined.NullOrUndefined (TimestampValue) , "ExecutionProperty" :: NullOrUndefined.NullOrUndefined (ExecutionProperty) , "Command" :: NullOrUndefined.NullOrUndefined (JobCommand) , "DefaultArguments" :: NullOrUndefined.NullOrUndefined (GenericMap) , "Connections" :: NullOrUndefined.NullOrUndefined (ConnectionsList) , "MaxRetries" :: NullOrUndefined.NullOrUndefined (MaxRetries) , "AllocatedCapacity" :: NullOrUndefined.NullOrUndefined (IntegerValue) } ) -> Job
...
--   This may be useful if you need to immediately overwrite some of the optional values
newJobBookmarkEntry' :: ( { "JobName" :: NullOrUndefined.NullOrUndefined (JobName) , "Version" :: NullOrUndefined.NullOrUndefined (IntegerValue) , "Run" :: NullOrUndefined.NullOrUndefined (IntegerValue) , "Attempt" :: NullOrUndefined.NullOrUndefined (IntegerValue) , "JobBookmark" :: NullOrUndefined.NullOrUndefined (JsonValue) } -> {"JobName" :: NullOrUndefined.NullOrUndefined (JobName) , "Version" :: NullOrUndefined.NullOrUndefined (IntegerValue) , "Run" :: NullOrUndefined.NullOrUndefined (IntegerValue) , "Attempt" :: NullOrUndefined.NullOrUndefined (IntegerValue) , "JobBookmark" :: NullOrUndefined.NullOrUndefined (JsonValue) } ) -> JobBookmarkEntry
...
--   This may be useful if you need to immediately overwrite some of the optional values
newJobCommand' :: ( { "Name" :: NullOrUndefined.NullOrUndefined (GenericString) , "ScriptLocation" :: NullOrUndefined.NullOrUndefined (ScriptLocationString) } -> {"Name" :: NullOrUndefined.NullOrUndefined (GenericString) , "ScriptLocation" :: NullOrUndefined.NullOrUndefined (ScriptLocationString) } ) -> JobCommand
...
--   This may be useful if you need to immediately overwrite some of the optional values
newJobRun' :: ( { "Id" :: NullOrUndefined.NullOrUndefined (IdString) , "Attempt" :: NullOrUndefined.NullOrUndefined (AttemptCount) , "PreviousRunId" :: NullOrUndefined.NullOrUndefined (IdString) , "TriggerName" :: NullOrUndefined.NullOrUndefined (NameString) , "JobName" :: NullOrUndefined.NullOrUndefined (NameString) , "StartedOn" :: NullOrUndefined.NullOrUndefined (TimestampValue) , "LastModifiedOn" :: NullOrUndefined.NullOrUndefined (TimestampValue) , "CompletedOn" :: NullOrUndefined.NullOrUndefined (TimestampValue) , "JobRunState" :: NullOrUndefined.NullOrUndefined (JobRunState) , "Arguments" :: NullOrUndefined.NullOrUndefined (GenericMap) , "ErrorMessage" :: NullOrUndefined.NullOrUndefined (ErrorString) , "PredecessorRuns" :: NullOrUndefined.NullOrUndefined (PredecessorList) , "AllocatedCapacity" :: NullOrUndefined.NullOrUndefined (IntegerValue) } -> {"Id" :: NullOrUndefined.NullOrUndefined (IdString) , "Attempt" :: NullOrUndefined.NullOrUndefined (AttemptCount) , "PreviousRunId" :: NullOrUndefined.NullOrUndefined (IdString) , "TriggerName" :: NullOrUndefined.NullOrUndefined (NameString) , "JobName" :: NullOrUndefined.NullOrUndefined (NameString) , "StartedOn" :: NullOrUndefined.NullOrUndefined (TimestampValue) , "LastModifiedOn" :: NullOrUndefined.NullOrUndefined (TimestampValue) , "CompletedOn" :: NullOrUndefined.NullOrUndefined (TimestampValue) , "JobRunState" :: NullOrUndefined.NullOrUndefined (JobRunState) , "Arguments" :: NullOrUndefined.NullOrUndefined (GenericMap) , "ErrorMessage" :: NullOrUndefined.NullOrUndefined (ErrorString) , "PredecessorRuns" :: NullOrUndefined.NullOrUndefined (PredecessorList) , "AllocatedCapacity" :: NullOrUndefined.NullOrUndefined (IntegerValue) } ) -> JobRun
...
--   This may be useful if you need to immediately overwrite some of the optional values
newJobUpdate' :: ( { "Description" :: NullOrUndefined.NullOrUndefined (DescriptionString) , "LogUri" :: NullOrUndefined.NullOrUndefined (UriString) , "Role" :: NullOrUndefined.NullOrUndefined (RoleString) , "ExecutionProperty" :: NullOrUndefined.NullOrUndefined (ExecutionProperty) , "Command" :: NullOrUndefined.NullOrUndefined (JobCommand) , "DefaultArguments" :: NullOrUndefined.NullOrUndefined (GenericMap) , "Connections" :: NullOrUndefined.NullOrUndefined (ConnectionsList) , "MaxRetries" :: NullOrUndefined.NullOrUndefined (MaxRetries) , "AllocatedCapacity" :: NullOrUndefined.NullOrUndefined (IntegerValue) } -> {"Description" :: NullOrUndefined.NullOrUndefined (DescriptionString) , "LogUri" :: NullOrUndefined.NullOrUndefined (UriString) , "Role" :: NullOrUndefined.NullOrUndefined (RoleString) , "ExecutionProperty" :: NullOrUndefined.NullOrUndefined (ExecutionProperty) , "Command" :: NullOrUndefined.NullOrUndefined (JobCommand) , "DefaultArguments" :: NullOrUndefined.NullOrUndefined (GenericMap) , "Connections" :: NullOrUndefined.NullOrUndefined (ConnectionsList) , "MaxRetries" :: NullOrUndefined.NullOrUndefined (MaxRetries) , "AllocatedCapacity" :: NullOrUndefined.NullOrUndefined (IntegerValue) } ) -> JobUpdate
...
--   This may be useful if you need to immediately overwrite some of the optional values
newJsonClassifier' :: JsonPath -> NameString -> ( { "Name" :: (NameString) , "CreationTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "LastUpdated" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "Version" :: NullOrUndefined.NullOrUndefined (VersionId) , "JsonPath" :: (JsonPath) } -> {"Name" :: (NameString) , "CreationTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "LastUpdated" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "Version" :: NullOrUndefined.NullOrUndefined (VersionId) , "JsonPath" :: (JsonPath) } ) -> JsonClassifier
...
--   This may be useful if you need to immediately overwrite some of the optional values
newLastCrawlInfo' :: ( { "Status" :: NullOrUndefined.NullOrUndefined (LastCrawlStatus) , "ErrorMessage" :: NullOrUndefined.NullOrUndefined (DescriptionString) , "LogGroup" :: NullOrUndefined.NullOrUndefined (LogGroup) , "LogStream" :: NullOrUndefined.NullOrUndefined (LogStream) , "MessagePrefix" :: NullOrUndefined.NullOrUndefined (MessagePrefix) , "StartTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) } -> {"Status" :: NullOrUndefined.NullOrUndefined (LastCrawlStatus) , "ErrorMessage" :: NullOrUndefined.NullOrUndefined (DescriptionString) , "LogGroup" :: NullOrUndefined.NullOrUndefined (LogGroup) , "LogStream" :: NullOrUndefined.NullOrUndefined (LogStream) , "MessagePrefix" :: NullOrUndefined.NullOrUndefined (MessagePrefix) , "StartTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) } ) -> LastCrawlInfo
...
--   This may be useful if you need to immediately overwrite some of the optional values
newLocation' :: ( { "Jdbc" :: NullOrUndefined.NullOrUndefined (CodeGenNodeArgs) , "S3" :: NullOrUndefined.NullOrUndefined (CodeGenNodeArgs) } -> {"Jdbc" :: NullOrUndefined.NullOrUndefined (CodeGenNodeArgs) , "S3" :: NullOrUndefined.NullOrUndefined (CodeGenNodeArgs) } ) -> Location
...
--   This may be useful if you need to immediately overwrite some of the optional values
newMappingEntry' :: ( { "SourceTable" :: NullOrUndefined.NullOrUndefined (TableName) , "SourcePath" :: NullOrUndefined.NullOrUndefined (SchemaPathString) , "SourceType" :: NullOrUndefined.NullOrUndefined (FieldType) , "TargetTable" :: NullOrUndefined.NullOrUndefined (TableName) , "TargetPath" :: NullOrUndefined.NullOrUndefined (SchemaPathString) , "TargetType" :: NullOrUndefined.NullOrUndefined (FieldType) } -> {"SourceTable" :: NullOrUndefined.NullOrUndefined (TableName) , "SourcePath" :: NullOrUndefined.NullOrUndefined (SchemaPathString) , "SourceType" :: NullOrUndefined.NullOrUndefined (FieldType) , "TargetTable" :: NullOrUndefined.NullOrUndefined (TableName) , "TargetPath" :: NullOrUndefined.NullOrUndefined (SchemaPathString) , "TargetType" :: NullOrUndefined.NullOrUndefined (FieldType) } ) -> MappingEntry
...
--   This may be useful if you need to immediately overwrite some of the optional values
newNoScheduleException' :: ( { "Message" :: NullOrUndefined.NullOrUndefined (MessageString) } -> {"Message" :: NullOrUndefined.NullOrUndefined (MessageString) } ) -> NoScheduleException
...
--   This may be useful if you need to immediately overwrite some of the optional values
newOperationTimeoutException' :: ( { "Message" :: NullOrUndefined.NullOrUndefined (MessageString) } -> {"Message" :: NullOrUndefined.NullOrUndefined (MessageString) } ) -> OperationTimeoutException
...
newtype Partition = Partition 
  ...
  , "CreationTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp)
  , "LastAccessTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp)
  , "StorageDescriptor" :: NullOrUndefined.NullOrUndefined (StorageDescriptor)
  , "Parameters" :: NullOrUndefined.NullOrUndefined (ParametersMap)
  , "LastAnalyzedTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp)
  }
...
--   This may be useful if you need to immediately overwrite some of the optional values
newPartition' :: ( { "Values" :: NullOrUndefined.NullOrUndefined (ValueStringList) , "DatabaseName" :: NullOrUndefined.NullOrUndefined (NameString) , "TableName" :: NullOrUndefined.NullOrUndefined (NameString) , "CreationTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "LastAccessTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "StorageDescriptor" :: NullOrUndefined.NullOrUndefined (StorageDescriptor) , "Parameters" :: NullOrUndefined.NullOrUndefined (ParametersMap) , "LastAnalyzedTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) } -> {"Values" :: NullOrUndefined.NullOrUndefined (ValueStringList) , "DatabaseName" :: NullOrUndefined.NullOrUndefined (NameString) , "TableName" :: NullOrUndefined.NullOrUndefined (NameString) , "CreationTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "LastAccessTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "StorageDescriptor" :: NullOrUndefined.NullOrUndefined (StorageDescriptor) , "Parameters" :: NullOrUndefined.NullOrUndefined (ParametersMap) , "LastAnalyzedTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) } ) -> Partition
...
--   This may be useful if you need to immediately overwrite some of the optional values
newPartitionError' :: ( { "PartitionValues" :: NullOrUndefined.NullOrUndefined (ValueStringList) , "ErrorDetail" :: NullOrUndefined.NullOrUndefined (ErrorDetail) } -> {"PartitionValues" :: NullOrUndefined.NullOrUndefined (ValueStringList) , "ErrorDetail" :: NullOrUndefined.NullOrUndefined (ErrorDetail) } ) -> PartitionError
...
--   This may be useful if you need to immediately overwrite some of the optional values
newPartitionInput' :: ( { "Values" :: NullOrUndefined.NullOrUndefined (ValueStringList) , "LastAccessTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "StorageDescriptor" :: NullOrUndefined.NullOrUndefined (StorageDescriptor) , "Parameters" :: NullOrUndefined.NullOrUndefined (ParametersMap) , "LastAnalyzedTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) } -> {"Values" :: NullOrUndefined.NullOrUndefined (ValueStringList) , "LastAccessTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "StorageDescriptor" :: NullOrUndefined.NullOrUndefined (StorageDescriptor) , "Parameters" :: NullOrUndefined.NullOrUndefined (ParametersMap) , "LastAnalyzedTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) } ) -> PartitionInput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newPhysicalConnectionRequirements' :: ( { "SubnetId" :: NullOrUndefined.NullOrUndefined (NameString) , "SecurityGroupIdList" :: NullOrUndefined.NullOrUndefined (SecurityGroupIdList) , "AvailabilityZone" :: NullOrUndefined.NullOrUndefined (NameString) } -> {"SubnetId" :: NullOrUndefined.NullOrUndefined (NameString) , "SecurityGroupIdList" :: NullOrUndefined.NullOrUndefined (SecurityGroupIdList) , "AvailabilityZone" :: NullOrUndefined.NullOrUndefined (NameString) } ) -> PhysicalConnectionRequirements
...
--   This may be useful if you need to immediately overwrite some of the optional values
newPredecessor' :: ( { "JobName" :: NullOrUndefined.NullOrUndefined (NameString) , "RunId" :: NullOrUndefined.NullOrUndefined (IdString) } -> {"JobName" :: NullOrUndefined.NullOrUndefined (NameString) , "RunId" :: NullOrUndefined.NullOrUndefined (IdString) } ) -> Predecessor
...
--   This may be useful if you need to immediately overwrite some of the optional values
newPredicate' :: ( { "Logical" :: NullOrUndefined.NullOrUndefined (Logical) , "Conditions" :: NullOrUndefined.NullOrUndefined (ConditionList) } -> {"Logical" :: NullOrUndefined.NullOrUndefined (Logical) , "Conditions" :: NullOrUndefined.NullOrUndefined (ConditionList) } ) -> Predicate
...
--   This may be useful if you need to immediately overwrite some of the optional values
newResetJobBookmarkResponse' :: ( { "JobBookmarkEntry" :: NullOrUndefined.NullOrUndefined (JobBookmarkEntry) } -> {"JobBookmarkEntry" :: NullOrUndefined.NullOrUndefined (JobBookmarkEntry) } ) -> ResetJobBookmarkResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newResourceNumberLimitExceededException' :: ( { "Message" :: NullOrUndefined.NullOrUndefined (MessageString) } -> {"Message" :: NullOrUndefined.NullOrUndefined (MessageString) } ) -> ResourceNumberLimitExceededException
...
--   This may be useful if you need to immediately overwrite some of the optional values
newResourceUri' :: ( { "ResourceType" :: NullOrUndefined.NullOrUndefined (ResourceType) , "Uri" :: NullOrUndefined.NullOrUndefined (URI) } -> {"ResourceType" :: NullOrUndefined.NullOrUndefined (ResourceType) , "Uri" :: NullOrUndefined.NullOrUndefined (URI) } ) -> ResourceUri
...
--   This may be useful if you need to immediately overwrite some of the optional values
newS3Target' :: ( { "Path" :: NullOrUndefined.NullOrUndefined (Path) , "Exclusions" :: NullOrUndefined.NullOrUndefined (PathList) } -> {"Path" :: NullOrUndefined.NullOrUndefined (Path) , "Exclusions" :: NullOrUndefined.NullOrUndefined (PathList) } ) -> S3Target
...
--   This may be useful if you need to immediately overwrite some of the optional values
newSchedule' :: ( { "ScheduleExpression" :: NullOrUndefined.NullOrUndefined (CronExpression) , "State" :: NullOrUndefined.NullOrUndefined (ScheduleState) } -> {"ScheduleExpression" :: NullOrUndefined.NullOrUndefined (CronExpression) , "State" :: NullOrUndefined.NullOrUndefined (ScheduleState) } ) -> Schedule
...
--   This may be useful if you need to immediately overwrite some of the optional values
newSchedulerNotRunningException' :: ( { "Message" :: NullOrUndefined.NullOrUndefined (MessageString) } -> {"Message" :: NullOrUndefined.NullOrUndefined (MessageString) } ) -> SchedulerNotRunningException
...
--   This may be useful if you need to immediately overwrite some of the optional values
newSchedulerRunningException' :: ( { "Message" :: NullOrUndefined.NullOrUndefined (MessageString) } -> {"Message" :: NullOrUndefined.NullOrUndefined (MessageString) } ) -> SchedulerRunningException
...
--   This may be useful if you need to immediately overwrite some of the optional values
newSchedulerTransitioningException' :: ( { "Message" :: NullOrUndefined.NullOrUndefined (MessageString) } -> {"Message" :: NullOrUndefined.NullOrUndefined (MessageString) } ) -> SchedulerTransitioningException
...
--   This may be useful if you need to immediately overwrite some of the optional values
newSchemaChangePolicy' :: ( { "UpdateBehavior" :: NullOrUndefined.NullOrUndefined (UpdateBehavior) , "DeleteBehavior" :: NullOrUndefined.NullOrUndefined (DeleteBehavior) } -> {"UpdateBehavior" :: NullOrUndefined.NullOrUndefined (UpdateBehavior) , "DeleteBehavior" :: NullOrUndefined.NullOrUndefined (DeleteBehavior) } ) -> SchemaChangePolicy
...
--   This may be useful if you need to immediately overwrite some of the optional values
newSerDeInfo' :: ( { "Name" :: NullOrUndefined.NullOrUndefined (NameString) , "SerializationLibrary" :: NullOrUndefined.NullOrUndefined (NameString) , "Parameters" :: NullOrUndefined.NullOrUndefined (ParametersMap) } -> {"Name" :: NullOrUndefined.NullOrUndefined (NameString) , "SerializationLibrary" :: NullOrUndefined.NullOrUndefined (NameString) , "Parameters" :: NullOrUndefined.NullOrUndefined (ParametersMap) } ) -> SerDeInfo
...
--   This may be useful if you need to immediately overwrite some of the optional values
newSkewedInfo' :: ( { "SkewedColumnNames" :: NullOrUndefined.NullOrUndefined (NameStringList) , "SkewedColumnValues" :: NullOrUndefined.NullOrUndefined (ColumnValueStringList) , "SkewedColumnValueLocationMaps" :: NullOrUndefined.NullOrUndefined (LocationMap) } -> {"SkewedColumnNames" :: NullOrUndefined.NullOrUndefined (NameStringList) , "SkewedColumnValues" :: NullOrUndefined.NullOrUndefined (ColumnValueStringList) , "SkewedColumnValueLocationMaps" :: NullOrUndefined.NullOrUndefined (LocationMap) } ) -> SkewedInfo
...
--   This may be useful if you need to immediately overwrite some of the optional values
newStartJobRunRequest' :: NameString -> ( { "JobName" :: (NameString) , "JobRunId" :: NullOrUndefined.NullOrUndefined (IdString) , "Arguments" :: NullOrUndefined.NullOrUndefined (GenericMap) , "AllocatedCapacity" :: NullOrUndefined.NullOrUndefined (IntegerValue) } -> {"JobName" :: (NameString) , "JobRunId" :: NullOrUndefined.NullOrUndefined (IdString) , "Arguments" :: NullOrUndefined.NullOrUndefined (GenericMap) , "AllocatedCapacity" :: NullOrUndefined.NullOrUndefined (IntegerValue) } ) -> StartJobRunRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newStartJobRunResponse' :: ( { "JobRunId" :: NullOrUndefined.NullOrUndefined (IdString) } -> {"JobRunId" :: NullOrUndefined.NullOrUndefined (IdString) } ) -> StartJobRunResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newStartTriggerResponse' :: ( { "Name" :: NullOrUndefined.NullOrUndefined (NameString) } -> {"Name" :: NullOrUndefined.NullOrUndefined (NameString) } ) -> StartTriggerResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newStopTriggerResponse' :: ( { "Name" :: NullOrUndefined.NullOrUndefined (NameString) } -> {"Name" :: NullOrUndefined.NullOrUndefined (NameString) } ) -> StopTriggerResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newStorageDescriptor' :: ( { "Columns" :: NullOrUndefined.NullOrUndefined (ColumnList) , "Location" :: NullOrUndefined.NullOrUndefined (LocationString) , "InputFormat" :: NullOrUndefined.NullOrUndefined (FormatString) , "OutputFormat" :: NullOrUndefined.NullOrUndefined (FormatString) , "Compressed" :: NullOrUndefined.NullOrUndefined (Boolean) , "NumberOfBuckets" :: NullOrUndefined.NullOrUndefined (Int) , "SerdeInfo" :: NullOrUndefined.NullOrUndefined (SerDeInfo) , "BucketColumns" :: NullOrUndefined.NullOrUndefined (NameStringList) , "SortColumns" :: NullOrUndefined.NullOrUndefined (OrderList) , "Parameters" :: NullOrUndefined.NullOrUndefined (ParametersMap) , "SkewedInfo" :: NullOrUndefined.NullOrUndefined (SkewedInfo) , "StoredAsSubDirectories" :: NullOrUndefined.NullOrUndefined (Boolean) } -> {"Columns" :: NullOrUndefined.NullOrUndefined (ColumnList) , "Location" :: NullOrUndefined.NullOrUndefined (LocationString) , "InputFormat" :: NullOrUndefined.NullOrUndefined (FormatString) , "OutputFormat" :: NullOrUndefined.NullOrUndefined (FormatString) , "Compressed" :: NullOrUndefined.NullOrUndefined (Boolean) , "NumberOfBuckets" :: NullOrUndefined.NullOrUndefined (Int) , "SerdeInfo" :: NullOrUndefined.NullOrUndefined (SerDeInfo) , "BucketColumns" :: NullOrUndefined.NullOrUndefined (NameStringList) , "SortColumns" :: NullOrUndefined.NullOrUndefined (OrderList) , "Parameters" :: NullOrUndefined.NullOrUndefined (ParametersMap) , "SkewedInfo" :: NullOrUndefined.NullOrUndefined (SkewedInfo) , "StoredAsSubDirectories" :: NullOrUndefined.NullOrUndefined (Boolean) } ) -> StorageDescriptor
...
newtype Table = Table 
  ...
  , "CreateTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp)
  , "UpdateTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp)
  , "LastAccessTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp)
  , "LastAnalyzedTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp)
...
--   This may be useful if you need to immediately overwrite some of the optional values
newTable' :: NameString -> ( { "Name" :: (NameString) , "DatabaseName" :: NullOrUndefined.NullOrUndefined (NameString) , "Description" :: NullOrUndefined.NullOrUndefined (DescriptionString) , "Owner" :: NullOrUndefined.NullOrUndefined (NameString) , "CreateTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "UpdateTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "LastAccessTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "LastAnalyzedTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "Retention" :: NullOrUndefined.NullOrUndefined (NonNegativeInteger) , "StorageDescriptor" :: NullOrUndefined.NullOrUndefined (StorageDescriptor) , "PartitionKeys" :: NullOrUndefined.NullOrUndefined (ColumnList) , "ViewOriginalText" :: NullOrUndefined.NullOrUndefined (ViewTextString) , "ViewExpandedText" :: NullOrUndefined.NullOrUndefined (ViewTextString) , "TableType" :: NullOrUndefined.NullOrUndefined (TableTypeString) , "Parameters" :: NullOrUndefined.NullOrUndefined (ParametersMap) , "CreatedBy" :: NullOrUndefined.NullOrUndefined (NameString) } -> {"Name" :: (NameString) , "DatabaseName" :: NullOrUndefined.NullOrUndefined (NameString) , "Description" :: NullOrUndefined.NullOrUndefined (DescriptionString) , "Owner" :: NullOrUndefined.NullOrUndefined (NameString) , "CreateTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "UpdateTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "LastAccessTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "LastAnalyzedTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "Retention" :: NullOrUndefined.NullOrUndefined (NonNegativeInteger) , "StorageDescriptor" :: NullOrUndefined.NullOrUndefined (StorageDescriptor) , "PartitionKeys" :: NullOrUndefined.NullOrUndefined (ColumnList) , "ViewOriginalText" :: NullOrUndefined.NullOrUndefined (ViewTextString) , "ViewExpandedText" :: NullOrUndefined.NullOrUndefined (ViewTextString) , "TableType" :: NullOrUndefined.NullOrUndefined (TableTypeString) , "Parameters" :: NullOrUndefined.NullOrUndefined (ParametersMap) , "CreatedBy" :: NullOrUndefined.NullOrUndefined (NameString) } ) -> Table
...
--   This may be useful if you need to immediately overwrite some of the optional values
newTableError' :: ( { "TableName" :: NullOrUndefined.NullOrUndefined (NameString) , "ErrorDetail" :: NullOrUndefined.NullOrUndefined (ErrorDetail) } -> {"TableName" :: NullOrUndefined.NullOrUndefined (NameString) , "ErrorDetail" :: NullOrUndefined.NullOrUndefined (ErrorDetail) } ) -> TableError
...
--   This may be useful if you need to immediately overwrite some of the optional values
newTableInput' :: NameString -> ( { "Name" :: (NameString) , "Description" :: NullOrUndefined.NullOrUndefined (DescriptionString) , "Owner" :: NullOrUndefined.NullOrUndefined (NameString) , "LastAccessTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "LastAnalyzedTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "Retention" :: NullOrUndefined.NullOrUndefined (NonNegativeInteger) , "StorageDescriptor" :: NullOrUndefined.NullOrUndefined (StorageDescriptor) , "PartitionKeys" :: NullOrUndefined.NullOrUndefined (ColumnList) , "ViewOriginalText" :: NullOrUndefined.NullOrUndefined (ViewTextString) , "ViewExpandedText" :: NullOrUndefined.NullOrUndefined (ViewTextString) , "TableType" :: NullOrUndefined.NullOrUndefined (TableTypeString) , "Parameters" :: NullOrUndefined.NullOrUndefined (ParametersMap) } -> {"Name" :: (NameString) , "Description" :: NullOrUndefined.NullOrUndefined (DescriptionString) , "Owner" :: NullOrUndefined.NullOrUndefined (NameString) , "LastAccessTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "LastAnalyzedTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "Retention" :: NullOrUndefined.NullOrUndefined (NonNegativeInteger) , "StorageDescriptor" :: NullOrUndefined.NullOrUndefined (StorageDescriptor) , "PartitionKeys" :: NullOrUndefined.NullOrUndefined (ColumnList) , "ViewOriginalText" :: NullOrUndefined.NullOrUndefined (ViewTextString) , "ViewExpandedText" :: NullOrUndefined.NullOrUndefined (ViewTextString) , "TableType" :: NullOrUndefined.NullOrUndefined (TableTypeString) , "Parameters" :: NullOrUndefined.NullOrUndefined (ParametersMap) } ) -> TableInput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newTableVersion' :: ( { "Table" :: NullOrUndefined.NullOrUndefined (Table) , "VersionId" :: NullOrUndefined.NullOrUndefined (VersionString) } -> {"Table" :: NullOrUndefined.NullOrUndefined (Table) , "VersionId" :: NullOrUndefined.NullOrUndefined (VersionString) } ) -> TableVersion
...
--   This may be useful if you need to immediately overwrite some of the optional values
newTableVersionError' :: ( { "TableName" :: NullOrUndefined.NullOrUndefined (NameString) , "VersionId" :: NullOrUndefined.NullOrUndefined (VersionString) , "ErrorDetail" :: NullOrUndefined.NullOrUndefined (ErrorDetail) } -> {"TableName" :: NullOrUndefined.NullOrUndefined (NameString) , "VersionId" :: NullOrUndefined.NullOrUndefined (VersionString) , "ErrorDetail" :: NullOrUndefined.NullOrUndefined (ErrorDetail) } ) -> TableVersionError
...
--   This may be useful if you need to immediately overwrite some of the optional values
newTrigger' :: ( { "Name" :: NullOrUndefined.NullOrUndefined (NameString) , "Id" :: NullOrUndefined.NullOrUndefined (IdString) , "Type" :: NullOrUndefined.NullOrUndefined (TriggerType) , "State" :: NullOrUndefined.NullOrUndefined (TriggerState) , "Description" :: NullOrUndefined.NullOrUndefined (DescriptionString) , "Schedule" :: NullOrUndefined.NullOrUndefined (GenericString) , "Actions" :: NullOrUndefined.NullOrUndefined (ActionList) , "Predicate" :: NullOrUndefined.NullOrUndefined (Predicate) } -> {"Name" :: NullOrUndefined.NullOrUndefined (NameString) , "Id" :: NullOrUndefined.NullOrUndefined (IdString) , "Type" :: NullOrUndefined.NullOrUndefined (TriggerType) , "State" :: NullOrUndefined.NullOrUndefined (TriggerState) , "Description" :: NullOrUndefined.NullOrUndefined (DescriptionString) , "Schedule" :: NullOrUndefined.NullOrUndefined (GenericString) , "Actions" :: NullOrUndefined.NullOrUndefined (ActionList) , "Predicate" :: NullOrUndefined.NullOrUndefined (Predicate) } ) -> Trigger
...
--   This may be useful if you need to immediately overwrite some of the optional values
newTriggerUpdate' :: ( { "Name" :: NullOrUndefined.NullOrUndefined (NameString) , "Description" :: NullOrUndefined.NullOrUndefined (DescriptionString) , "Schedule" :: NullOrUndefined.NullOrUndefined (GenericString) , "Actions" :: NullOrUndefined.NullOrUndefined (ActionList) , "Predicate" :: NullOrUndefined.NullOrUndefined (Predicate) } -> {"Name" :: NullOrUndefined.NullOrUndefined (NameString) , "Description" :: NullOrUndefined.NullOrUndefined (DescriptionString) , "Schedule" :: NullOrUndefined.NullOrUndefined (GenericString) , "Actions" :: NullOrUndefined.NullOrUndefined (ActionList) , "Predicate" :: NullOrUndefined.NullOrUndefined (Predicate) } ) -> TriggerUpdate
...
--   This may be useful if you need to immediately overwrite some of the optional values
newUpdateClassifierRequest' :: ( { "GrokClassifier" :: NullOrUndefined.NullOrUndefined (UpdateGrokClassifierRequest) , "XMLClassifier" :: NullOrUndefined.NullOrUndefined (UpdateXMLClassifierRequest) , "JsonClassifier" :: NullOrUndefined.NullOrUndefined (UpdateJsonClassifierRequest) } -> {"GrokClassifier" :: NullOrUndefined.NullOrUndefined (UpdateGrokClassifierRequest) , "XMLClassifier" :: NullOrUndefined.NullOrUndefined (UpdateXMLClassifierRequest) , "JsonClassifier" :: NullOrUndefined.NullOrUndefined (UpdateJsonClassifierRequest) } ) -> UpdateClassifierRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newUpdateConnectionRequest' :: ConnectionInput -> NameString -> ( { "CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "Name" :: (NameString) , "ConnectionInput" :: (ConnectionInput) } -> {"CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "Name" :: (NameString) , "ConnectionInput" :: (ConnectionInput) } ) -> UpdateConnectionRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newUpdateCrawlerRequest' :: NameString -> ( { "Name" :: (NameString) , "Role" :: NullOrUndefined.NullOrUndefined (Role) , "DatabaseName" :: NullOrUndefined.NullOrUndefined (DatabaseName) , "Description" :: NullOrUndefined.NullOrUndefined (DescriptionStringRemovable) , "Targets" :: NullOrUndefined.NullOrUndefined (CrawlerTargets) , "Schedule" :: NullOrUndefined.NullOrUndefined (CronExpression) , "Classifiers" :: NullOrUndefined.NullOrUndefined (ClassifierNameList) , "TablePrefix" :: NullOrUndefined.NullOrUndefined (TablePrefix) , "SchemaChangePolicy" :: NullOrUndefined.NullOrUndefined (SchemaChangePolicy) , "Configuration" :: NullOrUndefined.NullOrUndefined (CrawlerConfiguration) } -> {"Name" :: (NameString) , "Role" :: NullOrUndefined.NullOrUndefined (Role) , "DatabaseName" :: NullOrUndefined.NullOrUndefined (DatabaseName) , "Description" :: NullOrUndefined.NullOrUndefined (DescriptionStringRemovable) , "Targets" :: NullOrUndefined.NullOrUndefined (CrawlerTargets) , "Schedule" :: NullOrUndefined.NullOrUndefined (CronExpression) , "Classifiers" :: NullOrUndefined.NullOrUndefined (ClassifierNameList) , "TablePrefix" :: NullOrUndefined.NullOrUndefined (TablePrefix) , "SchemaChangePolicy" :: NullOrUndefined.NullOrUndefined (SchemaChangePolicy) , "Configuration" :: NullOrUndefined.NullOrUndefined (CrawlerConfiguration) } ) -> UpdateCrawlerRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newUpdateCrawlerScheduleRequest' :: NameString -> ( { "CrawlerName" :: (NameString) , "Schedule" :: NullOrUndefined.NullOrUndefined (CronExpression) } -> {"CrawlerName" :: (NameString) , "Schedule" :: NullOrUndefined.NullOrUndefined (CronExpression) } ) -> UpdateCrawlerScheduleRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newUpdateDatabaseRequest' :: DatabaseInput -> NameString -> ( { "CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "Name" :: (NameString) , "DatabaseInput" :: (DatabaseInput) } -> {"CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "Name" :: (NameString) , "DatabaseInput" :: (DatabaseInput) } ) -> UpdateDatabaseRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newUpdateDevEndpointRequest' :: GenericString -> ( { "EndpointName" :: (GenericString) , "PublicKey" :: NullOrUndefined.NullOrUndefined (GenericString) , "CustomLibraries" :: NullOrUndefined.NullOrUndefined (DevEndpointCustomLibraries) , "UpdateEtlLibraries" :: NullOrUndefined.NullOrUndefined (BooleanValue) } -> {"EndpointName" :: (GenericString) , "PublicKey" :: NullOrUndefined.NullOrUndefined (GenericString) , "CustomLibraries" :: NullOrUndefined.NullOrUndefined (DevEndpointCustomLibraries) , "UpdateEtlLibraries" :: NullOrUndefined.NullOrUndefined (BooleanValue) } ) -> UpdateDevEndpointRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newUpdateGrokClassifierRequest' :: NameString -> ( { "Name" :: (NameString) , "Classification" :: NullOrUndefined.NullOrUndefined (Classification) , "GrokPattern" :: NullOrUndefined.NullOrUndefined (GrokPattern) , "CustomPatterns" :: NullOrUndefined.NullOrUndefined (CustomPatterns) } -> {"Name" :: (NameString) , "Classification" :: NullOrUndefined.NullOrUndefined (Classification) , "GrokPattern" :: NullOrUndefined.NullOrUndefined (GrokPattern) , "CustomPatterns" :: NullOrUndefined.NullOrUndefined (CustomPatterns) } ) -> UpdateGrokClassifierRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newUpdateJobResponse' :: ( { "JobName" :: NullOrUndefined.NullOrUndefined (NameString) } -> {"JobName" :: NullOrUndefined.NullOrUndefined (NameString) } ) -> UpdateJobResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newUpdateJsonClassifierRequest' :: NameString -> ( { "Name" :: (NameString) , "JsonPath" :: NullOrUndefined.NullOrUndefined (JsonPath) } -> {"Name" :: (NameString) , "JsonPath" :: NullOrUndefined.NullOrUndefined (JsonPath) } ) -> UpdateJsonClassifierRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newUpdatePartitionRequest' :: NameString -> PartitionInput -> BoundedPartitionValueList -> NameString -> ( { "CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "DatabaseName" :: (NameString) , "TableName" :: (NameString) , "PartitionValueList" :: (BoundedPartitionValueList) , "PartitionInput" :: (PartitionInput) } -> {"CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "DatabaseName" :: (NameString) , "TableName" :: (NameString) , "PartitionValueList" :: (BoundedPartitionValueList) , "PartitionInput" :: (PartitionInput) } ) -> UpdatePartitionRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newUpdateTableRequest' :: NameString -> TableInput -> ( { "CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "DatabaseName" :: (NameString) , "TableInput" :: (TableInput) , "SkipArchive" :: NullOrUndefined.NullOrUndefined (BooleanNullable) } -> {"CatalogId" :: NullOrUndefined.NullOrUndefined (CatalogIdString) , "DatabaseName" :: (NameString) , "TableInput" :: (TableInput) , "SkipArchive" :: NullOrUndefined.NullOrUndefined (BooleanNullable) } ) -> UpdateTableRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newUpdateTriggerResponse' :: ( { "Trigger" :: NullOrUndefined.NullOrUndefined (Trigger) } -> {"Trigger" :: NullOrUndefined.NullOrUndefined (Trigger) } ) -> UpdateTriggerResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newUpdateXMLClassifierRequest' :: NameString -> ( { "Name" :: (NameString) , "Classification" :: NullOrUndefined.NullOrUndefined (Classification) , "RowTag" :: NullOrUndefined.NullOrUndefined (RowTag) } -> {"Name" :: (NameString) , "Classification" :: NullOrUndefined.NullOrUndefined (Classification) , "RowTag" :: NullOrUndefined.NullOrUndefined (RowTag) } ) -> UpdateXMLClassifierRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newUserDefinedFunction' :: ( { "FunctionName" :: NullOrUndefined.NullOrUndefined (NameString) , "ClassName" :: NullOrUndefined.NullOrUndefined (NameString) , "OwnerName" :: NullOrUndefined.NullOrUndefined (NameString) , "OwnerType" :: NullOrUndefined.NullOrUndefined (PrincipalType) , "CreateTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "ResourceUris" :: NullOrUndefined.NullOrUndefined (ResourceUriList) } -> {"FunctionName" :: NullOrUndefined.NullOrUndefined (NameString) , "ClassName" :: NullOrUndefined.NullOrUndefined (NameString) , "OwnerName" :: NullOrUndefined.NullOrUndefined (NameString) , "OwnerType" :: NullOrUndefined.NullOrUndefined (PrincipalType) , "CreateTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "ResourceUris" :: NullOrUndefined.NullOrUndefined (ResourceUriList) } ) -> UserDefinedFunction
...
--   This may be useful if you need to immediately overwrite some of the optional values
newUserDefinedFunctionInput' :: ( { "FunctionName" :: NullOrUndefined.NullOrUndefined (NameString) , "ClassName" :: NullOrUndefined.NullOrUndefined (NameString) , "OwnerName" :: NullOrUndefined.NullOrUndefined (NameString) , "OwnerType" :: NullOrUndefined.NullOrUndefined (PrincipalType) , "ResourceUris" :: NullOrUndefined.NullOrUndefined (ResourceUriList) } -> {"FunctionName" :: NullOrUndefined.NullOrUndefined (NameString) , "ClassName" :: NullOrUndefined.NullOrUndefined (NameString) , "OwnerName" :: NullOrUndefined.NullOrUndefined (NameString) , "OwnerType" :: NullOrUndefined.NullOrUndefined (PrincipalType) , "ResourceUris" :: NullOrUndefined.NullOrUndefined (ResourceUriList) } ) -> UserDefinedFunctionInput
...
--   This may be useful if you need to immediately overwrite some of the optional values
newValidationException' :: ( { "Message" :: NullOrUndefined.NullOrUndefined (MessageString) } -> {"Message" :: NullOrUndefined.NullOrUndefined (MessageString) } ) -> ValidationException
...
--   This may be useful if you need to immediately overwrite some of the optional values
newVersionMismatchException' :: ( { "Message" :: NullOrUndefined.NullOrUndefined (MessageString) } -> {"Message" :: NullOrUndefined.NullOrUndefined (MessageString) } ) -> VersionMismatchException
...
--   This may be useful if you need to immediately overwrite some of the optional values
newXMLClassifier' :: Classification -> NameString -> ( { "Name" :: (NameString) , "Classification" :: (Classification) , "CreationTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "LastUpdated" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "Version" :: NullOrUndefined.NullOrUndefined (VersionId) , "RowTag" :: NullOrUndefined.NullOrUndefined (RowTag) } -> {"Name" :: (NameString) , "Classification" :: (Classification) , "CreationTime" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "LastUpdated" :: NullOrUndefined.NullOrUndefined (Types.Timestamp) , "Version" :: NullOrUndefined.NullOrUndefined (VersionId) , "RowTag" :: NullOrUndefined.NullOrUndefined (RowTag) } ) -> XMLClassifier
